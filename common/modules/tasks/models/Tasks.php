...
class Tasks extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        if(class_exists('\common\modules\tickets\models\Tickets') && $this->_module->moduleLoaded('tickets'))
            $rules[] = [['ticket_id'], 'exist', 'skipOnError' => true, 'targetClass' => \common\modules\tickets\models\Tickets::class, 'targetAttribute' => ['ticket_id' => 'id']];
    ...
    {
        if (class_exists('\common\modules\tickets\models\Tickets') && $this->_module->moduleLoaded('tickets'))
            return $this->hasOne(\common\modules\tickets\models\Tickets::class, ['id' => 'ticket_id']);
        else
            return null;
    }
    ...
    public function getOwner()
    {
        if (class_exists('\common\modules\users\models\Users') && $this->_module->moduleLoaded('users'))
            return $this->hasOne(\common\modules\users\models\Users::class, ['id' => 'owner_id']);
        else
            return null;
    }
    ...
    {
        if (class_exists('\common\modules\users\models\Users') && $this->_module->moduleLoaded('users'))
            return $this->hasOne(\common\modules\users\models\Users::class, ['id' => 'executor_id']);
        else
            return null;
    }

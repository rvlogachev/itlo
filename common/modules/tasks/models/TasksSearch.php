...
/**
 * TasksSearch represents the model behind the search form of `common\modules\tasks\models\Tasks`.
 */
class TasksSearch extends Tasks
{
    ...
    public function search($params, $current_user = null)
    {
        ...
        if(!is_int($this->ticket_id) && !empty($this->ticket_id) && (class_exists('\common\modules\tickets\models\Tickets') && isset(Yii::$app->modules['tickets']))) {
            $ticket_id = \common\modules\tickets\models\Tickets::find()->andFilterWhere(['like', 'subject', $this->ticket_id])->one();

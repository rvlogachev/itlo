...
//            }
        ...
        if ($app->db->schema->getTableSchema(\common\modules\admin\models\Modules::tableName())) {
            $migrationLookup = [];
...
//                        }
                        ...
                        if (!class_exists($module['class'])) {
                            ...
                            if (!$app->hasModule($moduleId)) {
                                ...
                                if ($admin = Yii::$app->getModule('admin')) {
                                ...
                                if ($installed = $app->getModule('admin/' . $module['module'], true)) {
                                    ...
                                    $installed->layoutPath = '@common/modules/admin/views/layouts';
...
/*
            ...
            $app->controllerMap['migrate'] = [
                'class' => 'common\modules\admin\commands\MigrateController',

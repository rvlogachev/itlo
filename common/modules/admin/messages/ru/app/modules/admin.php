...
return [
    ...
    "Главная административная панель" => 'Main administrative panel',
    "Panel heading title" => 'Заголовок главной панели',
    'Modules' => 'Модули',
    'Login' => "Авторизация",
    ...
    'Submit' => "Отправить",
    'Settings' => "Настройки",
    'Timeline Event' => "Хроника приложения",
    'System Log' => "Логи системы",

    'System' => 'Система',
    'Debug Data' => 'Данные для отладки',
    'Routing prefix' => 'Префикс адреса',
    '- auto activate' => '- авто включение',
    'All rights reserved' => 'Все права защищены',
    'Database Status' => 'Статус подключения к БД',
    'Sphinx Search Status' => 'Статус сервера поиска sphinx',
    'OK! User {user} successfully deleted.' => 'OK! Пользователь {user} успешно удален',
    ...
    'ID' => "ИД",
    'Module ID' => "ИД модуля",
    'Controller ID' => "ИД контроллера",
    'Action ID' => "ИД действия",
    'Path URL' => "URL",
    'Module version' => "Версия модуля",
    'Module vendor' => "Производитель модуля",
    'Name' => "Название",
...
",
    ...
    'Task' => 'Задачу',
    'Translate' => 'Перевод',
    'Dashboards' => 'Рабочие области',
    'Main Dashboard' => 'Основная область',
    'Dashboard 1 (Common)' => 'Область 1 (Общая)',
    'Dashboard 2 (Content)' => 'Область 2 (Контент)',

                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" role="menu">
                             <?= Html::a(Yii::t('app/modules/admin', 'Run `phpinfo()`'), [
                                ...
                                'class' => 'dropdown-item btn btn-add btn-success pull-right',
                                'data' => [
                                    'toggle' => "modal",
                    ...
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            'upload_max_filesize' => [
                                ...
                                'value' => function ($data) {
                                    return  \common\modules\helpers\src\StringHelper::sizeFormatNormalize($data['upload_max_filesize'], 2);
                                }
                            ],
                            'post_max_size' => [
                                'label' => Yii::t('app/modules/admin', "Post max size"),
                                'value' => function ($data) {
                                    return \common\modules\helpers\src\StringHelper::sizeFormatNormalize($data['post_max_size'], 2);
                                }
                            ],
                            ...
                            'file_limit' => [
                                ...
                                'value' => function ($data) {
                                    return \common\modules\helpers\src\StringHelper::formatBytes($data['file_limit'], 2);
                                }
                            ],
                            'total_limit' => [
                                'label' => Yii::t('app/modules/admin', "Total limit"),
                                'value' => function ($data) {
                                    return \common\modules\helpers\src\StringHelper::formatBytes($data['total_limit'], 2);
                                }
                            ],
                            ...
                            'memory_limit' => [
                                ...
                                'value' => function ($data) {
                                    return \common\modules\helpers\src\StringHelper::sizeFormatNormalize($data['memory_limit'], 2) . (isset($data['memory_usage']) ? " (" . \common\modules\helpers\src\StringHelper::sizeFormatNormalize($data['memory_usage'], 2) ." usage)" : '');
                                }
                            ],
                            ...
                            'disk_space' => [
                                ...
                                'value' => function ($data) {
                                    return \common\modules\helpers\src\StringHelper::formatBytes(intval($data['disk_space']['free_space']), 2) . ' of ' .
                                        \common\modules\helpers\src\StringHelper::formatBytes(intval($data['disk_space']['total_space']), 2);
                                }
                            ],
                            'processes' => [
...
<div class="row">
        <div class="col-md-12">
            <div class="card collapsed-card">
                ...
                <div class="card-header">
                    <h3 class="card-title"><?=Yii::t('app/modules/admin', "Database Status");?></h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
...
<div class="row">
    <div class="col-md-12">
        <div class="card collapsed-card">
            <div class="card-header">
                <h3 class="card-title"><?=Yii::t('app/modules/admin', "Sphinx Search Status");?></h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        <i class="fas fa-plus"></i>
                    </button>
...
<div class="row">
    <div class="col-md-12">
        <div class="card collapsed-card">
            <div class="card-header">
                <h3 class="card-title"><?=Yii::t('app/modules/admin', "PHP extensions");?></h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        <i class="fas fa-plus"></i>
                    </button>
    ...
    $('body').delegate('[data-toggle="modal"][data-target]', 'click', function(event) {
        ...
        $.get(
            ...
            function (response, status, xhr) {
                ...
                $("#getPhpInfoModal .modal-header h4").after($("#getPhpInfoModal .modal-header button"));   

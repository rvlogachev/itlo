...
use Yii;
use common\modules\api\models\API;
use common\modules\api\models\APISearch;
...
class AccessController extends Controller
{
    ...
    public function actionTest()
    {
        ...
        $model = new \common\modules\base\models\DynamicModel(['action', 'request', 'method', 'accept']);

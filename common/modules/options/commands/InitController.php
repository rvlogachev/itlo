...
namespace common\modules\options\commands;

use Yii;
use yii\console\Controller;
use yii\console\ExitCode;
use common\modules\options\components\Options;
...
class InitController extends Controller
{
    ...
    public function actionIndex($params = null)
    {
        ...
        if ($selected == "1") {
            Yii::$app->runAction('migrate/up', ['migrationPath' => '@common/modules/options/migrations', 'interactive' => true]);
        } else if($selected == "2") {
            Yii::$app->runAction('migrate/down', ['migrationPath' => '@common/modules/options/migrations', 'interactive' => true]);
        } else if($selected == "3") {
            $count_success = 0;
            $count_fails = 0;
            ...
            if(class_exists('\common\modules\admin\models\Modules') && isset(Yii::$app->modules['admin'])) {
                $model = new \common\modules\admin\models\Modules();

...
if (isset(Yii::$app->translations) && class_exists('\common\modules\translations\FlagsAsset')) {
                ...
                <div class="card-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" role="menu">
                            <a href="/backend/web/admin/pages/" class="dropdown-item"><?=Yii::t('app/modules/pages', 'All pages');?></a>
...
<!--                --><?php //echo  Yii::t('app/modules/rbac', 'Here you can specify which roles and rights are inherited. The nesting level of inherited rights is not limited.') ?>
            </div>
        </div>
    </div>
</div>

...
use common\modules\translations\components\UrlManager;
...
class Module extends BaseModule
{
     ...
     * @note This variable will be override if you use the `common\modules\translations` module.
     */
    ...
    public function dashboardNavItems($createLink = false)
    {
        $items = [
            ...
            'icon' => FAS::i('layer-group',['class' => ['nav-icon']]),

...
namespace common\modules\votes;
...
use common\modules\votes\components\Votes;
...
class Module extends BaseModule
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'common\modules\votes\controllers';
    ...
    public function dashboardNavItems($createLink = false)
    {
        $items = [
            ...
            'icon' => FAS::icon('check-square', ['class' => ['nav-icon']]),

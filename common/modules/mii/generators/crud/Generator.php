...
namespace common\modules\mii\generators\crud;
...
class Generator extends \common\modules\mii\Generator
{
    ...
    public $viewPath;
    public $baseControllerClass = 'extended\controller\Controller';
    public $indexWidgetType = 'grid';
    public $searchModelClass = 'common\models\search\Search';
    ...
    public function generateActiveField($attribute)
    {
        ...
        if($column->dbType=='date' || $column->dbType=='datetime'){
            return "\$form->field(\$model, '$attribute')->widget(DateTimePicker::className(), [
        'model' => \$model,
    ...
    public function generateSearchConditions()
    {
        ...
        foreach ($columns as $column => $type)
            switch ($type) {
                ...
                case Schema::TYPE_DATETIME:
                case Schema::TYPE_TIMESTAMP:
                    $conditions[] = "if(isset(\$_GET['{$column}From']))\n\t\t\t\$query->andWhere(\"$column>=STR_TO_DATE('{\$_GET['{$column}From']}', '%Y-%m-%d %H:%i:%s')\");" ;
                    $conditions[] = "if(isset(\$_GET['{$column}To']))\n\t\t\t\$query->andWhere(\"$column<=STR_TO_DATE('{\$_GET['{$column}To']}', '%Y-%m-%d %H:%i:%s')\");\n" ;
                    break;
            }

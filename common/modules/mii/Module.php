 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'common\modules\mii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends BaseModule implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'common\modules\mii\controllers';
    /**
     ...
     */
    public $description = "Mii as GII Generator";
    ...
    public $allowedIPs = ['192.168.1.109', '::1'];
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'common\modules\mii\console\GenerateController',
    ...
    {
        $items = [
            'label' => Yii::t('app/modules/mii',"Mii"),
            'url' => [$this->routePrefix . '/'. $this->id],
            'icon' => FAS::i('cogs',['class' => ['nav-icon']]),
    ...
    {
        return [
            'model' => ['class' => 'common\modules\mii\generators\model\Generator'],
            'crud' => ['class' => 'common\modules\mii\generators\crud\Generator'],
            'controller' => ['class' => 'common\modules\mii\generators\controller\Generator'],
            'form' => ['class' => 'common\modules\mii\generators\form\Generator'],
            'module' => ['class' => 'common\modules\mii\generators\module\Generator'],
            'extension' => ['class' => 'common\modules\mii\generators\extension\Generator'],
        ];
    }
}

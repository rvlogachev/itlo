    ...
    public function safeUp()
    {
        if ($this->db->driverName === 'mysql') {
            if (class_exists('\common\modules\pages\models\Pages')) {
                $tableName = \common\modules\pages\models\Pages::tableName();
            ...
            if (class_exists('\common\modules\blog\models\Posts')) {
                $tableName = \common\modules\blog\models\Posts::tableName();

...
class Module extends BaseModule
{
    ...
    public $supportModels = [
        ...
        'blog' => [
            'class' => 'common\modules\blog\models\Posts',
            'indexing' => [
                'on_insert' => true,
                'on_update' => true,
                'on_delete' => true
        ...
        'pages' => [
            'class' => 'common\modules\pages\models\Pages',
            'indexing' => [
                'on_insert' => true,
                'on_update' => true,
                'on_delete' => true
    ...
    public function dashboardNavItems($options = false)
    {
        ...
        $items = [
            'label' => Yii::t('app/modules/search',$this->name),
            'url' => '#',
            ...
            'items' => [
                [
                    ...
                    'icon' => FAS::i('square',['class' => ['nav-icon']]),
                ...
                [
                    ...
                    'icon' =>  FAS::i('circle',['class' => ['nav-icon']]),
        ...
        if (!$this->isConsole() && is_array($models = $this->supportModels)) {
            ...
            foreach ($models as $context => $support) {
                ...
                if (isset($support['class']) && isset($support['options'])) {
                    ...
                    $moduleFind = Modules::find()->where(['status'=>Modules::MODULE_STATUS_ACTIVE,'class'=>$class])->one();

                    // If class of model exist
                    if (class_exists($class) && isset($moduleFind) && isset($support['indexing'])) {

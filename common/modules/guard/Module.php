...
namespace common\modules\guard;
...
use common\modules\guard\filters\RateLimit;
use common\modules\guard\behaviors\RequestBehavior;
use common\modules\guard\models\Security;
use common\modules\guard\models\Scanning;
...
class Module extends BaseModule
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'common\modules\guard\controllers';
    ...
    public $scanReport = [
        'emailViewPath' => [
            'html' => "@common/modules/guard/mail/report-html",
            'text' => "@common/modules/guard/mail/report-text"
        ],
        ...
        return [
            ...
            'items' => [
                [
                    ...
                    'icon' => FAS::icon('traffic-light', ['class' => ['nav-icon']]),

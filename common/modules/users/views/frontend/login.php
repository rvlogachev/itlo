                            ...
                            [
                                ...
                                'buttons'=> [
                                    'view' => function($url, $data, $key) {
                                        return Html::a('<i class="fa fa-eye"></i>', Url::to(['/admin/users/users/view',  'id' => $data['id']]), [
                                    ...
                                    'delete' => function($url, $data, $key) {
                                        return Html::a('<span class="fa fa-times"></span>',
                                            Url::to(['/admin/users/users/delete',      'id' => $data['id'],]),
                                            ['data' => [
                                                'method' => 'post',
                                            ],
                                    ...
                                    'update' => function($url, $data, $key) {
                                        return Html::a('<i class="fa fa-pen"></i>', Url::to(['/admin/users/users/update', 'id' => $data['id']]), [

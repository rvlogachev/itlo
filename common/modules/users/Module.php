...
class Module extends BaseModule
{
    ...
    public $signupConfirmation = [
        ...
        'emailViewPath' => [
            'html' => 'common/modules/users/mail/signupConfirmation-html',
            'text' => 'common/modules/users/mail/signupConfirmation-text',
        ],
    ];
    public $passwordReset = [
        ...
        'supportEmail' => 'noreply@example.com',
        'emailViewPath' => [
            'html' => 'common/modules/users/mail/passwordReset-html',
            'text' => 'common/modules/users/mail/passwordReset-text',
        ],
    ];

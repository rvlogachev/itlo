...
class Module extends BaseModule
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'common\modules\turbo\controllers';
    ...
    public $supportModels = [
        'pages' => 'common\modules\pages\models\Pages',
        'news' => 'common\modules\news\models\News',
        'blog' => 'common\modules\blog\models\Posts'
    ];
    ...
    {
        $items = [
            'label' => Yii::t('app/modules/turbo',$this->name),
            'icon' => FAS::icon('rocket', ['class' => ['nav-icon']]),

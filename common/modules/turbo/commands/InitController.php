...
namespace common\modules\turbo\commands;
...
class InitController extends Controller
{
    ...
    public function actionIndex($params = null)
    {
        ...
        if ($selected == "1") {
            Yii::$app->runAction('migrate/up', ['migrationPath' => '@common/modules/turbo/migrations', 'interactive' => true]);
        } else if($selected == "2") {
            Yii::$app->runAction('migrate/down', ['migrationPath' => '@common/modules/turbo/migrations', 'interactive' => true]);
        } else if($selected == "3") {

...
<div id="sx-search" style="margin-bottom: 10px;">
    <!--<p><b><a data-pjax="0" target="_blank" href="<?php /*= $packageModel->url; */ ?>"><?php /*=\Yii::t('skeeks/marketplace','{yii} Version',['yii' => 'SkeekS CMS'])*/ ?></a>: </b> <?php /*= \Yii::$app->cms->descriptor->version; */ ?></p>-->
    <p><b><?= \Yii::t('skeeks/marketplace', '{yii} Version', ['yii' => 'Yii']) ?>: </b> <?= Yii::getVersion(); ?></p>
    <p><b>SkeekS CMS: </b> <?= Yii::$app->cms->version; ?></p>
    <?php if (file_exists($composerLockFile)) : ?>

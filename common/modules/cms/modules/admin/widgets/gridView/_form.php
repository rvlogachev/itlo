...
?>
    ...
    <?php $columns         = \yii\helpers\ArrayHelper::getValue($controller->callableData, 'columns'); ?>
    <?php $selectedColumns = \yii\helpers\ArrayHelper::getValue($controller->callableData, 'selectedColumns'); ?>

...
use common\modules\cms\actions\LogoutAction;
...
use common\modules\cms\models\forms\BlockedUserForm;
use common\modules\cms\models\forms\LoginFormUsernameOrEmail;
use common\modules\cms\models\forms\PasswordResetRequestFormEmailOrLogin;
...
class AdminAuthController extends BackendController
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                'class' => \common\modules\cms\modules\backend\AdminAccessControl::class,
                'only'  => [
                    'logout',
                    'lock'

...
use common\modules\cms\models\CmsDashboard;
use common\modules\cms\models\CmsDashboardWidget;
...
class AdminIndexController extends BackendController
{
    ...
    public function actionIndex()
    {
        ...
        return $this->redirect(
            UrlHelper::construct(['/adm/admin-index/dashboard', 'pk' => $dashboard->id])->enableAdmin()->toString()
        );
    }
    ...
    public function actionDashboard()
    {
        ...
        $this->layout = '@common/modules/cms/modules/backend/views/layouts/main-empty';
    ...
    public function actionDashboardRemove()
    {
        ...
        try {
            $dashboard->delete();
            $rr->redirect = UrlHelper::construct(['/adm/index'])->enableAdmin()->toString();
            $rr->success = true;

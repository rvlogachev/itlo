...
/* @var $dashboard common\modules\cms\models\CmsDashboard */
$model = new \common\modules\cms\models\CmsDashboard();
$modelWidget = new \common\modules\cms\models\CmsDashboardWidget();
...
<?php $createModal = \yii\bootstrap4\Modal::begin([
...
//    'header'    => '<b>' . \Yii::t('skeeks/admin', 'Add widget') . '</b>',
    ...
    <?php $form = \common\modules\cms\modules\admin\widgets\ActiveForm::begin([
        ...
        'usePjax'           => false,
        'useAjaxSubmit'     => true,
        'validationUrl'     => \common\modules\cms\helpers\UrlHelper::construct(['admin/admin-index/dashboard-widget-create-validate', 'pk' => $model->id])->enableAdmin()->toString(),
        'action'            => \common\modules\cms\helpers\UrlHelper::construct(['admin/admin-index/dashboard-widget-create-save', 'pk' => $model->id])->enableAdmin()->toString(),
...
//    'header'    => '<b>' . \Yii::t('skeeks/admin', 'Add desktop') . '</b>',
    ...
    <?php $form = \common\modules\cms\modules\admin\widgets\ActiveForm::begin([
            ...
            'usePjax'           => false,
            'useAjaxSubmit'     => true,
            'validationUrl'     => \common\modules\cms\helpers\UrlHelper::construct(['admin/admin-index/dashboard-create-validate', 'pk' => $model->id])->enableAdmin()->toString(),
            'action'            => \common\modules\cms\helpers\UrlHelper::construct(['admin/admin-index/dashboard-create-save', 'pk' => $model->id])->enableAdmin()->toString(),
...
//    'header'    => '<b>' . \Yii::t('skeeks/admin', 'Desktop customization') . '</b>',
    ...
    <?php $form = \common\modules\cms\modules\admin\widgets\ActiveForm::begin([
            ...
            'usePjax'           => false,
            'useAjaxSubmit'     => true,
            'validationUrl'     => \common\modules\cms\helpers\UrlHelper::construct(['admin/admin-index/dashboard-validate', 'pk' => $dashboard->id])->enableAdmin()->toString(),
            'action'            => \common\modules\cms\helpers\UrlHelper::construct(['admin/admin-index/dashboard-save', 'pk' => $dashboard->id])->enableAdmin()->toString(),
...
$jsonData = \yii\helpers\Json::encode([
    ...
    'removeBackend' => \common\modules\cms\helpers\UrlHelper::construct(['/admin/admin-index/dashboard-remove', 'pk' => $dashboard->id])->enableAdmin()->toString(),
]);

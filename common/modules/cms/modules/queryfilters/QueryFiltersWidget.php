...
use common\modules\cms\modules\queryfilters\filters\NumberFilterField;
use common\modules\cms\modules\queryfilters\filters\StringFilterField;
use common\modules\cms\widgets\DualSelect;
 ...
 * @package common\modules\cms\cmsWidgets\filters
 */
class QueryFiltersWidget extends Widget
{
    ...
    public function run()
    {
        ...
        $builder = new \common\modules\cms\modules\form\Builder([

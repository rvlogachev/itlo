...
/* @var $panel \common\modules\cms\modules\toolbar\panels\CachePanel */
?>
...
$clearCacheOptions = \yii\helpers\Json::encode([
    'backend' => \common\modules\backend\helpers\BackendUrlHelper::createByParams(['/cms/admin-clear/index'])->url
]);

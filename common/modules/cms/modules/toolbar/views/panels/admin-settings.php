...
$urlSettings = \common\modules\backend\helpers\BackendUrlHelper::createByParams(['/cms/admin-settings'])
    ->enableEmptyLayout()
    ->url;
?>
<div class="sx-cms-toolbar__block">
    <a onclick="new sx.classes.toolbar.Dialog('<?= $urlSettings; ?>'); return false;"
       href="<?= $urlSettings; ?>" title="<?= \Yii::t('skeeks/toolbar', 'Managing project settings', [],
        ...
        <div class="sx-cms-toolbar__label sx-cms-toolbar__label_info">
            ...
            <?= \Yii::t('skeeks/toolbar',
                'Settings', [], \Yii::$app->admin->languageCode) ?></span>
        </div>
    </a>
</div>

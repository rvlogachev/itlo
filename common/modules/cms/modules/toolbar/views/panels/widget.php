...
<div class="sx-cms-toolbar__block">
    <div class="sx-cms-toolbar__label <?= \Yii::$app->cmsToolbar->editWidgets == \common\modules\cms\components\Cms::BOOL_Y ? "sx-cms-toolbar__label_success" : ""; ?>">
        <input type="checkbox" value="1"
               onclick="sx.Toolbar.triggerEditWidgets();" <?= \Yii::$app->cmsToolbar->editWidgets == \common\modules\cms\components\Cms::BOOL_Y ? "checked" : ""; ?>/>
        <img height="21"

...
<?= $form->fieldSet(\Yii::t('skeeks/form2/app', 'Basic settings')) ?>
    ...
    <?php if ($handler) : ?>
        ...
        <?php if($handler instanceof \skeeks\cms\relatedProperties\propertyTypes\PropertyTypeList) : ?>
            <?php $handler->enumRoute = 'form2/admin-form-property-enum'; ?>
            <?php $handler->enumClass = \skeeks\modules\cms\form2\models\Form2FormPropertyEnum::class; ?>
        <?php endif; ?>
...
<?= $form->fieldSet(\Yii::t('skeeks/form2/app', 'Additionally')) ?>
    ...
    <?php if ($content_id = \Yii::$app->request->get('form_id')) : ?>

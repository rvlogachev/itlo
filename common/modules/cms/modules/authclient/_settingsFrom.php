...
?>
<?php $fieldSet = $form->fieldSet(\Yii::t('skeeks/authclient','Are common')); ?>
    <?= $form->field($model, 'enabled')->checkbox(); ?>
<?php $fieldSet::end(); ?>

<?php $fieldSet = $form->fieldSet('GitHub'); ?>
...
<?php $fieldSet = $form->fieldSet('Facebook'); ?>
...
<?php $fieldSet = $form->fieldSet('Google'); ?>

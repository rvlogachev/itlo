 ...
 */
(function (b, f, d) {
    if (b.Skeeks || b.sx)throw Error("Skeeks or sx object is already defined in global namespace.");
    var a = b.sx = b.Skeeks = {};
    a._ = d;
    a.$ = f;
    a.createNamespace = function (c, b) {
        b = b || a;
        for (var e = c.split("."), g = b, d = 0, f = e.length; d < f; ++d) {
            var k = e[d];
            g[k] || (g[k] = {});
            g = g[k]
        }
...
(function (b, f) {
    ...
    b.classes.Base.extend = function (d) {
        ...
        (a = d[e], f.isFunction(a) && (c.prototype[e] = a));
...
(function (b, f, d) {
    ...
    b.classes._Entity = b.classes.Base.extend({
        construct: function (a) {
            ...
            a = a || {};
            this._opts = d.extend(a, this._opts || {});
            return this
        }, exist: function (a) {
    ...
    b.classes.Entity =
        b.classes._Entity.extend({})
})(sx, sx.$, sx._);
(function (b, f, d) {
    b.EventManager = {
        _$: f("<div/>"), _hooks: {}, trigger: function (a, c) {
            if (this._hooks[a] && this._hooks[a].length)for (var b = 0, h = this._hooks[a].length; b < h; ++b) {
            ...
            if (this._hooks[a] &&
                this._hooks[a].length)for (var b = 0, d = this._hooks[a].length; b < d; ++b)c == this._hooks[a][b] && (this._hooks[a][b] = null);
            return this
        }, hooks: function () {
            return this._hooks
        }
    ...
    b.createNamespace("classes", b);
    b.classes.EventManager = b.classes.Base.extend({
        _hooks: {}, construct: function (a) {
            this._opts = a || {};
            this._$ = f("<div/>")
            ...
            if (this._hooks[a] && this._hooks[a].length)for (var b = 0, d = this._hooks[a].length; b < d; ++b)c == this._hooks[a][b] && (this._hooks[a][b] = null);
            return this
        }, hooks: function () {
            return this._hooks
        }
...
(function (b, f, d) {
    ...
    b.classes._Config = b.classes.Entity.extend({
        _init: function () {
            this.mergeDefaults({env: "dev", lang: "ru", loadedTime: null, cookie: {namespace: "sx"}})
        }, isDev: function () {
...
(function (b, f, d) {
    b.createNamespace("classes", b);
    b.classes._Cookie = b.classes.Base.extend({
        _globalNamespace: b.config.get("cookie").namespace, _namespace: "", _opts: "", construct: function (a, c) {
            this._namespace = a || "";
            this._opts = c || {}
        }, set: function (a, c, e) {
    ...
    b.cookie = {
        _defaultOptions: {path: "/"}, set: function (a, c, b) {
            b = b || {};
            null === c && (c =
                "", b.expires = -1);
            var e = "";
            b.expires && ("number" == typeof b.expires || b.expires.toUTCString) && ("number" == typeof b.expires ? (e = new Date, e.setTime(e.getTime() + 864E5 * b.expires)) : e = b.expires, e = "; expires=" + e.toUTCString());
            b = d.extend(this._defaultOptions, b);
            var g = b.path ? "; path=" + b.path : "", f = b.domain ? "; domain=" + b.domain : "";
            b = b.secure ? "; secure" : "";
            document.cookie = [a, "=", encodeURIComponent(c), e, g, f, b].join("")
        }, get: function (a) {
            var b = null;
            if (document.cookie && "" != document.cookie)for (var e = document.cookie.split(";"),
                                                                  d = 0; d < e.length; d++) {
            ...
            var a = {};
            if (document.cookie && "" != document.cookie)for (var c = document.cookie.split(";"), e = 0; e < c.length; e++) {
                var d = jQuery.trim(c[e]), g = b.helpers.String.strpos(d, "=", 0);
                if (g) {
                    var f = decodeURIComponent(d.substring(g + 1));
                    d = decodeURIComponent(d.substring(0, g));
...
(function (b, f, d, a) {
    ...
    b.classes._Component = b.classes.Entity.extend({
        _coreInit: function () {
            ...
            if ("complete" == document.readyState) c._windowReady(); else f(a).on("load",
                function () {
                    c._windowReady()
                })
        }, _init: function () {
            ...
            null ===
            this._cookieManager && (this._cookieManager = new b.classes.Cookie);
    ...
    b.registerComponent = function (a) {
        if (!(a instanceof b.classes._Component))throw Error("Instance of sx.classes.Component was expected.");
        b.components.push(a);
        return a
    }
})(sx, sx.$, sx._, window);
(function (b, f, d) {
    ...
    b.classes._AjaxHandler = b.classes.Component.extend({
        construct: function (a, c) {
            if (!(a instanceof b.classes._AjaxQuery))throw Error("invalid ajaxQuery class");
            c = c || {};
            this._ajaxQuery = a;
    ...
    b.classes._AjaxQuery = b.classes.Component.extend({
        _url: "", construct: function (a, c) {
            ...
            var a = this, b = this.get("ajaxStart");
            ...
            b = this.get("complete");
            null !==
            b && (this.onComplete(b), this.set("complete", null));
            b = this.get("success");
    ...
    b.ajax = {
        ...
        registerQuery: function (a) {
            if (!(a instanceof b.classes._AjaxQuery))throw Error("Instance of sx.classes._AjaxQuery was expected.");
            this.queries.push(a);
            return a
        },
        ...
        _onDomReady: function () {
            ...
            }).bind(a.ajaxStop, function () {
                b.EventManager.trigger(a.ajaxStop)
            }).bind(a.ajaxSend, function () {
                b.EventManager.trigger(a.ajaxSend)
            }).bind(a.ajaxSuccess, function () {
                b.EventManager.trigger(a.ajaxSuccess)
            }).bind(a.ajaxError, function () {
                b.EventManager.trigger(a.ajaxError)
            }).bind(a.ajaxComplete, function () {
                b.EventManager.trigger(a.ajaxComplete)
            })
        },
        prepareGetQuery: function (a,
                                   c, e) {
            e = e || {};

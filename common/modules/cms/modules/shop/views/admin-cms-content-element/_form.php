...
JS
        ...
        <div style="display: none;">
            ...
            <?php if (!$model->isNewRecord) : ?>
                <?php /*= $form->fieldSet(\Yii::t('skeeks/shop/app','Additionally')); */ ?><!--
            <?php /*= $form->fieldSelect($model, 'content_id', \skeeks\cms\models\CmsContent::getDataForSelect()); */ ?>
        --><?php /*= $form->fieldSetEnd() */ ?>

                <?php if ($model->cmsContent->is_access_check_element) : ?>
                    <?php $fieldSet = $form->fieldSet(\Yii::t('skeeks/shop/app', 'Access')); ?>
            ...
            <?php if ($shopContent->childrenContent && $model->cmsContent->getChildrenContents()->andWhere([
                    '!=',
                    'id',
                ...
                <?php $childContents = $model->cmsContent->getChildrenContents()->andWhere([
                    '!=',
                    'id',
                    $shopContent->childrenContent->id,
                ])->all(); ?>

                <?php foreach ($childContents as $childContent) : ?>
                    <?php $fieldSet = $form->fieldSet($childContent->name); ?>
    ...
    <?php if ($shopStoreProduct || $shopProduct->supplier_external_jsondata && 1 == 2) : ?>
<?
$this->registerJs(<<<JS
...
?>
    <div class="sx-subproduct-info js-scrollbar sx-bg-secondary">
        ...
        <?php if ($shopStoreProduct || $shopProduct->supplier_external_jsondata) : ?>
    </div>
<?php endif; ?>
</div>

...
?>
<?php if ($createAction = \yii\helpers\ArrayHelper::getValue($controller->actions, 'create')) : ?>
    <div class="g-mb-20">
...
JS
                ...
                <?php foreach ($dm->availableProperties as $property) : ?>

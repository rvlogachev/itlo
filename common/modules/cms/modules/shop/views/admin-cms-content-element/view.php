        ...
        <div class="col-12">
            ...
            <div class="sx-table-wrapper table-responsive">
                <table class="table sx-table">
                    <tr>
                        <?php foreach ($model->cmsSite->shopTypePrices as $shopTypePrice) : ?>
...
JS
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php if (count(\Yii::$app->money->activeCurrencies) > 1) : ?>
                                            <?php echo \yii\helpers\Html::listBox("price_currency_code", $price ? $price->money->currency->code : "", \yii\helpers\ArrayHelper::map(
                                    ...
                                    <?php echo \yii\helpers\Html::checkbox("is_fixed", ($price && $price->is_fixed ? true : false), [
                                            'label' => 'Зафиксирована?',
                                    ]); ?>
                                    </div>
            ...
            <div class="sx-properties-wrapper sx-columns-3" style="margin-top: 5px;">
                <ul class="sx-properties">
                    ...
                    <?php foreach ($attributes as $code => $value) : ?>
                        <?php $property = $infoModel->relatedPropertiesModel->getRelatedProperty($code); ?>
                        <li>
                            <span class="sx-properties--name">
                                <?php echo $rp->getAttributeLabel($code); ?>
                                <?php if ($property->hint) : ?>
                            ...
                            <span class="sx-properties--value">
                                <?php if ($value) : ?>
                                    ...
                                    <?php if ($property->cms_measure_code) : ?>

...
<h1 style="text-align: center;">Новый заказ для покупателя: <a href="#"
                                                               class="sx-change-user"><?= $shopFuser->user->displayName; ?></a>
</h1>
...
<?php /*= \skeeks\widget\chosen\Chosen::widget([
...
<?php if ($shopFuser->buyer) : ?>
    ...
    <?php /* elseif ($shopFuser->personType) : */ ?>

    <?php /* $buyer = $shopFuser->personType->createModelShopBuyer(); */ ?><!--

        <?php /* if ($properties = $buyer->relatedProperties) : */ ?>
            <?php /* foreach ($properties as $property) : */ ?>
                <?php /*= $property->renderActiveForm($form, $buyer); */ ?>
            <?php /* endforeach; */ ?>
        --><?php /* endif; */ ?>
<?php else : ?>

<?php
namespace common\modules\cms\modules\shop\models;

use common\modules\cms\components\Cms;
use common\modules\cms\helpers\StringHelper;
use common\modules\cms\models\behaviors\HasJsonFieldsBehavior;
use common\modules\cms\models\CmsContentElement;
use common\modules\cms\modules\money\Currency;
 ...
 */
class ShopProduct extends \common\modules\cms\models\Core
{
    ...
    static public function getInstanceByContentElement(CmsContentElement $cmsContentElement)
    {
         ...
         */
        if ($cmsContentElement instanceof \common\modules\cms\shop\models\ShopCmsContentElement) {
    ...
    /**
     * @return array|\common\modules\cms\query\CmsActiveQuery|\common\modules\cms\query\CmsContentElementActiveQuery
     */

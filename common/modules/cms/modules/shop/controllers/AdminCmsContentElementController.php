...
use common\modules\backend\widgets\SelectModelDialogContentElementWidget;
...
use common\modules\cms\queryfilters\filters\NumberFilterField;
use common\modules\cms\queryfilters\filters\StringFilterField;
use common\modules\cms\queryfilters\QueryFiltersEvent;
use common\modules\cms\rbac\CmsManager;
use common\modules\cms\shop\assets\admin\AdminShopProductAsset;
use common\modules\cms\shop\components\ShopComponent;
use common\modules\cms\shop\grid\ShopProductColumn;
use common\modules\cms\shop\models\ShopCmsContentElement;
use common\modules\cms\shop\models\ShopProduct;
use common\modules\cms\shop\models\ShopProductPrice;
use common\modules\cms\shop\models\ShopProductRelation;
use common\modules\cms\shop\models\ShopStore;
use common\modules\cms\shop\models\ShopStoreProduct;
use common\modules\cms\widgets\GridView;
use common\modules\yii2\form\fields\BoolField;
use common\modules\yii2\form\fields\HtmlBlock;
use common\modules\yii2\form\fields\SelectField;
use common\modules\yii2\form\fields\TextField;
use common\modules\yii2\form\fields\WidgetField;
 ...
 */
class AdminCmsContentElementController extends \common\modules\cms\controllers\AdminCmsContentElementController
{
        ...
        $actions = ArrayHelper::merge(parent::actions(), [
                ...
                "offers" => [
                    ...
                    'on gridInit'            => function ($e) {
                        ...
                        $helper = new \common\modules\cms\shop\helpers\ShopOfferChooseHelper([
                        ...
                        $action->relatedIndexAction->on('beforeRender', function (Event $event) use ($controller, $helper) {
                            ...
                            $event->content = \Yii::$app->view->render("@common\modules/cms/shop/views/admin-cms-content-element/rp-header", [
                ...
                "relations" => [
                    ...
                    'accessCallback' => function (BackendModelAction $action) {
                        ...
                        /**
                         * @var $site \common\modules\cms\shop\models\CmsSite
                         */
                        $site = $model->cmsSite;

...
<?php if ($this->theme->is_image_body_begin) : ?>
...
<section class="g-pb-0">
    <div class="container g-bg-white">
        <div class="row">
            <!-- Content -->
            <?php if ($this->theme->tree_content_layout == 'col-left') : ?>
                <div class="col-md-9 order-md-2 g-py-20">
            <?php endif; ?>
            <?php if ($this->theme->tree_content_layout == 'col-right') : ?>
                <div class="col-md-9 g-py-20">
            <?php endif; ?>
            <?php if ($this->theme->tree_content_layout == 'no-col') : ?>
                <div class="col-md-12 g-py-20">
            <?php endif; ?>
            <?php if ($this->theme->tree_content_layout == 'col-left-right') : ?>
            ...
            <?php endif; ?>
                ...
                <div class="g-color-gray-dark-v1 g-font-size-16 sx-content" itemscope itemtype="http://schema.org/NewsArticle">
                    ...
                    <?php if ($model->image && $isShowMainImage && !$this->theme->is_image_body_begin) : ?>
                        <div class="g-mb-20">
                    ...
                    <?php endif; ?>
                    <!--<img src="<?php /*= \skeeks\cms\helpers\Image::getCapSrc(); */ ?>" title="<?php /*= $model->name; */ ?>" alt="<?php /*= $model->name; */ ?>" class="img-responsive" />-->
                    <?php if (!$this->theme->is_image_body_begin) : ?>

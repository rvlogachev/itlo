...
<div class="col-md-12 align-self-center">
    ...
    <?php /* if ($model->cmsTree) : */ ?><!--
            <li class="list-inline-item">
                <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="<?php /*= $model->cmsTree->url; */ ?>"><?php /*= $model->cmsTree->name; */ ?></a>
            </li>
            <li class="list-inline-item">/</li>
        --><?php /* endif; */ ?>
    ...
    <div>
        <a href="<?= $model->absoluteUrl; ?>" title="<?= $model->name; ?>" data-pjax="0">
            ...
            <?php elseif ($model->cmsTree->dir == 'news/releases'): ?>
                <?

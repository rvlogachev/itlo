...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <!--<link rel="icon" type="image/x-icon" href="<?php /*= $this->theme->favicon; */ ?>"/>-->
        <?php $this->head() ?>
    </head>
    <body>
    <?php $this->beginBody() ?>
...
CSS
    ...
    <div>
        <main>
            <?php /*= $this->render("@app/views/header"); */ ?>
            <?= $content; ?>
            <?php /*= $this->render("@app/views/footer"); */ ?>
        </main>
    </div>
    ...
    <?php /*= $this->render("@app/views/modals"); */ ?>

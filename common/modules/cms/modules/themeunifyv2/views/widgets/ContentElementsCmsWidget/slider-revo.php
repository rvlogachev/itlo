          ...
          <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
            <ul>
              ...
              >
                ...
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                  <?php if ($tree->relatedPropertiesModel->getAttribute('slide_title')) : ?>
                  ...
                  <?php if ($tree->relatedPropertiesModel->getAttribute('slide_title2')) : ?>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption   tp-resizeme"
                  ...
                  <?php if ($tree->relatedPropertiesModel->getAttribute('slide_btn')) : ?>
                  <!-- LAYER NR. 5 -->

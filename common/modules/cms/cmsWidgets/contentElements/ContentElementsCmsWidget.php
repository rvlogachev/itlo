<?php
namespace common\modules\cms\cmsWidgets\contentElements;
...
use common\modules\cms\widgets\formInputs\selectTree\SelectTree;
...
{
    public $contentElementClass = '\common\modules\cms\models\CmsContentElement';
        ...
        return [
            ...
            'sort'         => [
                ...
                'fields' => [
                    ...
                    'orderBy' => [
                        'class' => SelectField::class,
                        'items' => (new \common\modules\cms\models\Tree())->attributeLabels(),
                    ],
                    'order'   => [
                        'class' => SelectField::class,
                        'items' => [

...
.. code-block:: php
    ...
    <?php echo \skeeks\cms\cmsWidgets\text\TextCmsWidget::widget([
...
.. code-block:: php
    ...
    <?php \skeeks\cms\cmsWidgets\text\TextCmsWidget::begin([
        'namespace' => 'unique-settings-code',
    ]); ?>
    <p class="cl-gray ">
        Edited text
...
.. code-block:: php
    ...
    <?php \skeeks\cms\cmsWidgets\text\TextCmsWidget::beginWidget('unique-settings-code'); ?>
    <p class="cl-gray ">
        Edited text
    </p>
    <?php \skeeks\cms\cmsWidgets\text\TextCmsWidget::end(); ?>
...
.. code-block:: php
    ...
    <?php $widget = \skeeks\cms\cmsWidgets\treeMenu\TreeMenuCmsWidget::beginWidget('menu-top-1', [
      ...
      'enabledRunCache' => \skeeks\cms\components\Cms::BOOL_N,
        ...
        ?>
    <?php \skeeks\cms\cmsWidgets\treeMenu\TreeMenuCmsWidget::end(); ?>
...
.. code-block:: php
    ...
    ?>
    <?php if ($widget->dataProvider->query->count() > 1) : ?>
        <h5><?= $widget->label; ?>:</h5>
        <div class="news__posts">
            <?php foreach ($widget->dataProvider->query->all() as $element) : ?>

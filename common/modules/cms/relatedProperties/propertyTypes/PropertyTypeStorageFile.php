 ...
 * @package common\modules\cms\relatedProperties\propertyTypes
 */
class PropertyTypeStorageFile extends PropertyType
{
    ...
    public function addRules()
    {
        if ($this->isMultiple) {
            ...
            $this->property->relatedPropertiesModel->addRule($this->property->code, \common\modules\cms\validators\FileValidator::class, [
                'skipOnEmpty' => false,

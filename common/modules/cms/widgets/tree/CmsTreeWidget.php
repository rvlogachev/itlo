 ...
 *
 * Class CmsTreeWidget
 * @package common\modules\cms\widgets\tree
 */
class CmsTreeWidget extends Widget
{
     ...
     */
    public $pjax = null;
    public $pjaxClass = 'common\modules\cms\widgets\Pjax';
    public $pjaxOptions = [
        'isBlock' => true
    ];
    ...
    public function getOpenCloseLink($model)
    {
        ...
        return '/backend/web'.$currentLink;
    }

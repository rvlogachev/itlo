...
use common\modules\cms\modules\codemirror\CodemirrorWidget;
...
class ComboTextInputWidget extends InputWidget
{
    ...
    /**
     * @var \common\modules\cms\widgets\formInputs\ckeditor\Ckeditor
     */
    ...
    protected function registerPlugin()
    {
        ...
        $this->ckeditor = new \common\modules\cms\widgets\formInputs\ckeditor\Ckeditor(ArrayHelper::merge([
            'model' => $this->model,

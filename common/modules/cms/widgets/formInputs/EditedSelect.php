...
class EditedSelect extends Chosen
{
    ...
    public function run()
    {
        ...
        $createUrl = (string)\common\modules\backend\helpers\BackendUrlHelper::createByParams([$this->controllerRoute . '/' . $this->createAction])
            ->merge($this->additionalData)
            ->enableEmptyLayout()
            ->enableNoActions()
            ->url;

        $updateUrl = (string)\common\modules\backend\helpers\BackendUrlHelper::createByParams([$this->controllerRoute . '/' . $this->updateAction])
            ->merge($this->additionalData)
            ->enableEmptyLayout()
            ->url;

...
use common\modules\cms\IHasConfig;
...
use common\modules\cms\traits\HasComponentDbSettingsTrait;
...
abstract class Component extends Model implements ConfigFormInterface
{
    ...
    public function getEditUrl()
    {
        ...
        return \common\modules\backend\helpers\BackendUrlHelper::createByParams(['/cms/admin-component-settings/index'])
            ->merge([
    ...
    {
        return \common\modules\backend\helpers\BackendUrlHelper::createByParams(['/cms/admin-component-settings/call-edit'])
            ->merge([
                'componentClassName' => $this->className(),
                'componentNamespace' => $this->namespace,

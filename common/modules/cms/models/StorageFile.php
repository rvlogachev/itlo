...
use common\modules\cms\components\storage\ClusterLocal;
use Yii;
 ...
 *
 * @property \common\modules\cms\components\storage\Cluster $cluster
 */
class StorageFile extends Core
{
    ...
    public function delete()
    {
        ...
        } catch (\common\modules\cms\components\storage\Exception $e) {
            return false;
        }

 ...
 * @var $controller \common\modules\cms\controllers\AdminComponentSettingsController
 */
...
<div class="sx-box g-mb-10">
    ...
    <?php if ($settings = \common\modules\cms\models\CmsComponentSettings::findByComponentDefault($component)->one()) : ?>

...
/* @var $model \common\modules\cms\models\CmsUser */
/* @var $console \common\modules\cms\controllers\AdminUserController */
...
<div class="row">
    ...
    <div class="col-md-5">
        <?php
         \common\modules\cms\modules\backend\assets\JqueryMaskInputAsset::register($this);
...
<?php if (!$model->isNewRecord && class_exists('\common\modules\cms\authclient\models\UserAuthClient')) : ?>

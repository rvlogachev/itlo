...
<div class="sx-controll-node row">
    ...
    $controller = \Yii::$app->getModule("admin/cms")->createControllerByID("admin-tree");
    ...
    <?php $widget = \common\modules\backend\widgets\ContextMenuControllerActionsWidget::begin([
    ...
    <?php /*= \skeeks\cms\backend\widgets\DropdownControllerActionsWidget::widget([
        "actions" => $controller->modelActions,
    ...
    if ($model->level > 0  && \Yii::$app->user->can('root')) : ?>
        <div class="pull-left sx-controll-act">
    ...
    <?php if ($callbackEventName = \common\modules\backend\helpers\BackendUrlHelper::createByParams()->setBackendParamsByCurrentRequest()->callbackEventName) : ?>

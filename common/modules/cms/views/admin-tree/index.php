...
?>
<div class="col-md-12">
    <?php $widget = \common\modules\cms\widgets\tree\CmsTreeWidget::begin([
        "models" => $models,
        "viewNodeContentFile" => '@common/modules/cms/views/admin-tree/_tree-node',

        'pjaxClass' => \common\modules\cms\modules\admin\widgets\Pjax::class,
        /*'pjaxOptions' =>
            [
    ...
    $options = \yii\helpers\Json::encode([
        ...
        'backendNewChild' => \common\modules\cms\helpers\UrlHelper::construct(['/cms/admin-tree/new-children'])->enableAdmin()->toString(),
        'backendResort' => \common\modules\cms\helpers\UrlHelper::construct(['/cms/admin-tree/resort'])->enableAdmin()->toString()
    ]);

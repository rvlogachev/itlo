...
use common\modules\cms\assets\CmsAsset;
...
use common\modules\cms\modules\admin\widgets\formInputs\OneImage;
use common\modules\cms\rbac\CmsManager;
use common\modules\cms\relatedProperties\PropertyType;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeBool;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeElement;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeFile;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeList;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeNumber;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeStorageFile;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeText;
use common\modules\cms\relatedProperties\propertyTypes\PropertyTypeTree;
use common\modules\cms\relatedProperties\userPropertyTypes\UserPropertyTypeColor;
use common\modules\cms\relatedProperties\userPropertyTypes\UserPropertyTypeComboText;
use common\modules\cms\relatedProperties\userPropertyTypes\UserPropertyTypeDate;
use common\modules\cms\relatedProperties\userPropertyTypes\UserPropertyTypeSelectFile;
 ...
 *
 * @property \common\modules\cms\Module       $moduleCms
 ...
 */
class Cms extends \common\modules\cms\base\Component
{
    /**
                ...
                'fields' => [
                    'access' => [
                        ...
                        'content' => function (HtmlBlock $htmlBlock) {
                            ...
                            $content .= \common\modules\cms\modules\admin\widgets\BlockTitleWidget::widget([
                                'content' => "Файлы",
                            ]);
                            $content .= \common\modules\cms\rbac\widgets\adminPermissionForRoles\AdminPermissionForRolesWidget::widget([
                                'permissionName' => \common\modules\cms\rbac\CmsManager::PERMISSION_ELFINDER_USER_FILES,
                                'label'          => 'Доступ к личным файлам',
                            ]);
                            $content .= \common\modules\cms\rbac\widgets\adminPermissionForRoles\AdminPermissionForRolesWidget::widget([
                                'permissionName' => \common\modules\cms\rbac\CmsManager::PERMISSION_ELFINDER_COMMON_PUBLIC_FILES,
                                'label'          => 'Доступ к общим файлам',
                            ]);
                            $content .= \common\modules\cms\rbac\widgets\adminPermissionForRoles\AdminPermissionForRolesWidget::widget([
                                'permissionName' => \common\modules\cms\rbac\CmsManager::PERMISSION_ELFINDER_ADDITIONAL_FILES,
    ...
    /**
     * @return null|\common\modules\cms\Module
     */
    ...
    public function generateTmpConfig()
    {
        ...
        $configs = array_unique(array_merge(
            [
                \Yii::getAlias('@common/modules/cms/config/main.php'),
            ], $configs
        ));

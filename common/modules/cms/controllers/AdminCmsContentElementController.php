...
use common\modules\backend\actions\BackendModelMultiDialogEditAction;
...
use common\modules\backend\widgets\SelectModelDialogTreeWidget;
use common\modules\backend\widgets\SelectModelDialogUserWidget;
...
use common\modules\cms\models\CmsContentElementProperty;
use common\modules\cms\models\CmsContentPropertyEnum;
use common\modules\cms\modules\admin\actions\AdminAction;
use common\modules\cms\modules\admin\actions\modelEditor\AdminModelEditorAction;
                ...
                'grid'    => [
                    ...
                    'columns'        => [
                        ...
                        'active'       => [
                            ...
                            'value'          => function (\common\modules\cms\models\CmsContentElement $model) {
                                if ($model->active == "Y") {
...
HTML;
            ...
            "change-tree-multi" => [
                ...
                "viewDialog"   => "@common/modules/cms/views/admin-cms-content-element/change-tree-form",
            ...
            "change-trees-multi" => [
                ...
                "viewDialog"   => "@common/modules/cms/views/admin-cms-content-element/change-trees-form",
            ...
            "rp" => [
                ...
                "viewDialog"   => "@common/modules/cms/views/admin-cms-content-element/multi-rp",
    ...
    public function initGridData($action, $content)
    {
        ...
        if ($model) {
            ...
            foreach ($relatedPropertiesModel->toArray($relatedPropertiesModel->attributes()) as $name => $value) {
                ...
                if ($property->property_type == \common\modules\cms\relatedProperties\PropertyType::CODE_STRING) {
                ...
                } elseif ($property->property_type == \common\modules\cms\relatedProperties\PropertyType::CODE_BOOL) {
                ...
                } elseif ($property->property_type == \common\modules\cms\relatedProperties\PropertyType::CODE_NUMBER) {


                } elseif ($property->property_type == \common\modules\cms\relatedProperties\PropertyType::CODE_LIST) {
                    ...
                    if ($count > 100) {
                        $autoFilters["property{$property->id}"] = [
                            'class'        => WidgetField::class,
                            'widgetClass'  => \common\modules\backend\widgets\SelectModelDialogWidget::class,
                            'widgetConfig' => [
                                'modelClassName' => \common\modules\cms\models\CmsContentPropertyEnum::class,
                                'dialogRoute'    => [
                ...
                } elseif ($property->property_type == \common\modules\cms\relatedProperties\PropertyType::CODE_ELEMENT) {
                    ...
                    if ($count > 100) {
                        $autoFilters["property{$property->id}"] = [
                            'class'        => WidgetField::class,
                            'widgetClass'  => \common\modules\backend\widgets\SelectModelDialogContentElementWidget::class,
                            'widgetConfig' => [
                ...
                } elseif ($property->property_type == \common\modules\cms\relatedProperties\PropertyType::CODE_TREE) {
                    $propertyType = $property->handler;
                    $autoFilters["property{$property->id}"] = [
                        'class'       => WidgetField::class,
                        'widgetClass' => \common\modules\backend\widgets\SelectModelDialogTreeWidget::class,
                        'label'       => \yii\helpers\ArrayHelper::getValue($relatedPropertiesModel->attributeLabels(), $name)." [свойство]",
                        'on apply'    => function (QueryFiltersEvent $e) use ($property) {
                            /**
                             * @var $query ActiveQuery
    ...
    {
        $href = '';
//            \yii\helpers\Html::a('Настройках контента',
//            \common\modules\cms\helpers\UrlHelper::construct([
...
HTML
    ...
    public function create($adminAction)
    {
        ...
        if ($content_id = \Yii::$app->request->get("content_id")) {
            $contentModel = \common\modules\cms\models\CmsContent::findOne($content_id);
    ...
    public static function getDefaultColumns($cmsContent = null)
    {
        $columns = [
            [
                'class' => \common\modules\cms\grid\ImageColumn2::class,
            ],
            'name',
            ['class' => \common\modules\cms\grid\CreatedAtColumn::class],
            [
                'class'   => \common\modules\cms\grid\UpdatedAtColumn::class,
                'visible' => false,
            ],
            [
                'class'   => \common\modules\cms\grid\PublishedAtColumn::class,
                'visible' => false,
            ],
            [
                'class'     => \common\modules\cms\grid\DateTimeColumnData::class,
                'attribute' => "published_to",
                'visible'   => false,
            ],
            ['class' => \common\modules\cms\grid\CreatedByColumn::class],
            //['class' => \common\modules\cms\grid\UpdatedByColumn::class],
            [
                ...
                'format'    => 'raw',
                'filter'    => false,
                //'filter' => \common\modules\cms\helpers\TreeOptions::getAllMultiOptions(),
                'attribute' => 'tree_id',
            ],
            'additionalSections' => [
                'class'   => \yii\grid\DataColumn::class,
            ...
            [
                'attribute' => 'active',
                'class'     => \common\modules\cms\grid\BooleanColumn::class,
            ],
            [
                'class'  => \yii\grid\DataColumn::class,
                'label'  => "Смотреть",
    ...
    public static function getColumnsByContent($cmsContent = null, $dataProvider = null)
    {
        ...
        if (is_array($model) || is_object($model)) {
            ...
            $searchRelatedPropertiesModel = new \common\modules\cms\models\searchs\SearchRelatedPropertiesModel();

...
use common\modules\cms\modules\simpleajaxuploader\backend\FileUpload;
use Yii;
use common\modules\cms\models\StorageFile;
use common\modules\cms\models\searchs\StorageFile as StorageFileSearch;
...
class StorageFilesController extends Controller
{
    ...
    public function actionUpload()
    {
        ...
        $dir = \common\modules\cms\modules\sx\Dir::runtimeTmp();
    ...
    /**
     * ���������� � ������ ������ ����
     * @see common\modules\cms\widgets\formInputs\StorageImage

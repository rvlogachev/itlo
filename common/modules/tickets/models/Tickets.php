...
class Tickets extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        if(class_exists('\common\modules\tasks\models\Tasks') && $this->_module->moduleLoaded('tasks'))
            $rules[] = [['task_id'], 'exist', 'skipOnError' => true, 'targetClass' => \common\modules\tasks\models\Tasks::class, 'targetAttribute' => ['task_id' => 'id']];
    ...
    {
        if (class_exists('\common\modules\tasks\models\Tasks') && $this->_module->moduleLoaded('tasks'))
            return $this->hasOne(\common\modules\tasks\models\Tasks::class, ['id' => 'task_id']);
        else
            return null;
    }
    ...
    {
        if (class_exists('\common\modules\tasks\models\TasksSubunits') && $this->_module->moduleLoaded('tasks'))
            return $this->hasOne(\common\modules\tasks\models\TasksSubunits::class, ['id' => 'subunit_id']);
        else
            return null;
    }
    ...
    public function getAssigned()
    {
        if (class_exists('\common\modules\users\models\Users') && $this->_module->moduleLoaded('users'))
            return $this->hasOne(\common\modules\users\models\Users::class, ['id' => 'assigned_id']);
        else
            return null;
    }
    ...
    {
        if (class_exists('\common\modules\users\models\Users') && $this->_module->moduleLoaded('users') && !$user_id)
            return $this->hasOne(\common\modules\users\models\Users::class, ['id' => 'user_id']);
        else if (class_exists('\common\modules\users\models\Users') && $this->_module->moduleLoaded('users') && $user_id)
            return \common\modules\users\models\Users::findOne(['id' => intval($user_id)]);
        else
            return null;
    }

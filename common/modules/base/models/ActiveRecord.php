...
use common\modules\base\behaviors\SluggableBehavior;
    ...
    public function rules()
    {
        ...
        if ($this->hasAttribute('created_by')) {
            ...
            if (class_exists('common\modules\users\models\Users'))
                $rules[] = ['created_by', 'exist', 'skipOnError' => true, 'targetClass' => \common\modules\users\models\Users::class, 'targetAttribute' => ['created_by' => 'id']];
        }
        ...
        if ($this->hasAttribute('updated_by')) {
            ...
            if (class_exists('common\modules\users\models\Users'))
                $rules[] = ['updated_by', 'exist', 'skipOnError' => true, 'targetClass' => \common\modules\users\models\Users::class, 'targetAttribute' => ['updated_by' => 'id']];
        }

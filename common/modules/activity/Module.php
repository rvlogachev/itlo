...
namespace common\modules\activity;
...
class Module extends BaseModule
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'common\modules\activity\controllers';
    ...
    {
        $items = [
            'label' => Yii::t('app/modules/activity',$this->name),
    ...
    public function bootstrap($app)
    {
        ...
        $app->setComponents([
            'activity' => [
                'class' => 'common\modules\activity\components\Activity'
            ]
        ]);

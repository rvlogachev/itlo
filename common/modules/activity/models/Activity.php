...
namespace common\modules\activity\models;
...
class Activity extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        ...
        if(class_exists('\common\modules\cms\models\User') && isset(Yii::$app->modules['users']))
            $rules[] = [['user_id'], 'exist', 'skipOnError' => true, 'targetClass' =>  User::class, 'targetAttribute' => ['user_id' => 'id']];
    ...
    public function behaviors()
    {
        return [
            ...
            'metadata' => [
                'class' => 'common\modules\activity\behaviors\MetadataBehavior',
                'in_attribute' => 'action',
    ...
    {
        $user = null;
        if (class_exists('\common\modules\cms\models\User') && $user_id)
            $user = User::findOne(['id' => intval($user_id)]);
    ...
    {
        if (class_exists('\common\modules\cms\models\User')) {

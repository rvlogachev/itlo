...
/* @var $searchModel common\modules\geo\models\GeoCountriesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app/modules/geo', 'Countries');
...
?>
    ...
    <div class="geo-countries-index">
        ...
        <div>
            ...
            <?= Html::a(Yii::t('app/modules/geo', 'Add new country'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
        </div>
        <?php Pjax::end(); ?>
    </div>

        ...
        'attributes' => [
            ...
            [
                ...
                'value' => function($model) {
                    if($model->source_id) {
                        if ($model->source_type == common\modules\geo\models\GeoTranslations::TR_COUNTRY) {
                            return Html::a($model->source['title'], ['../admin/geo/countries/view/?id='.$model->source_id], [
                                    'target' => '_blank',
                                    'data-pjax' => 0
                                ]) . ' (ID: '.$model->source_id.')';
                        } elseif ($model->source_type == common\modules\geo\models\GeoTranslations::TR_REGION) {
                            return Html::a($model->source['title'], ['../admin/geo/regions/view/?id='.$model->source_id], [
                                    'target' => '_blank',
                                    'data-pjax' => 0
                                ]) . ' (ID: '.$model->source_id.')';
                        } elseif ($model->source_type == common\modules\geo\models\GeoTranslations::TR_CITY) {

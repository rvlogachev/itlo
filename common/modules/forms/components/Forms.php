...
namespace common\modules\forms\components;
...
use common\modules\base\models\DynamicModel;
...
class Forms extends Component
{
    ...
    {
        parent::init();
        $this->model = new \common\modules\forms\models\Forms;
    }
            ...
            //if (is_countable($collect) && $fields = $form->getFormsFields(['source_id' => null], true, false)->all()) {
                ...
                if ($model->load($collect) && $model->validate()) {
                    ...
                    if (is_countable($attributes)) {
                        ...
                        $submit = new \common\modules\forms\models\Submits();
                        ...
                        if ($submit->validate()) {
                            ...
                            if ($submit->save()) {
                                ...
                                foreach ($attributes as $attribute => $value) {
                                    ...
                                    $content = new \common\modules\forms\models\Content();

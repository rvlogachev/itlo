...
class Content extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['value'], 'string'],
            [['input_id'], 'exist', 'skipOnError' => true, 'targetClass' => Fields::class, 'targetAttribute' => ['input_id' => 'id']],
            [['submit_id'], 'exist', 'skipOnError' => true, 'targetClass' => Submits::class, 'targetAttribute' => ['submit_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Fields::class, ['id' => 'input_id']);
    }
    ...
    {
        return $this->hasOne(Submits::class, ['id' => 'submit_id']);
    }
}

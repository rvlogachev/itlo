...
namespace common\modules\forms\commands;
...
class InitController extends Controller
{
    ...
    public function actionIndex($params = null)
    {
        ...
        if ($selected == "1") {
            Yii::$app->runAction('migrate/up', ['migrationPath' => '@common/modules/forms/migrations', 'interactive' => true]);
        } else if($selected == "2") {
            Yii::$app->runAction('migrate/down', ['migrationPath' => '@common/modules/forms/migrations', 'interactive' => true]);
        } else if($selected == "3") {

            echo $this->ansiFormat("\n");

            $datetime = date("Y-m-d H:i:sP");
            $formsTable = \common\modules\forms\models\Forms::tableName();
            ...
            $datetime = date("Y-m-d H:i:sP");
            $fieldsTable = \common\modules\forms\models\Fields::tableName();

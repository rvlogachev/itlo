...
class Module extends BaseModule
{
    ...
    public function bootstrap($app)
    {
        ...
        if ($mailer->useFileTransport === true)
            $mailer->fileTransportCallback = '\common\modules\mailer\Module::generateMessageFileName';
        ...
        if (!($app instanceof \yii\console\Application) && $this->module && ($app->mailer instanceof \yii\base\Component)) {
            ...
            \yii\base\Event::on(\yii\mail\BaseMailer::class, \yii\mail\BaseMailer::EVENT_AFTER_SEND, function ($event) {
                ...
                $mails = new \common\modules\mailer\models\Mails();
        ...
        $app->setComponents([
            'mails' => [
                'class' => 'common\modules\mailer\components\Mails'
            ]
        ]);

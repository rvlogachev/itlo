...
use common\modules\bot\components\telegram\Entities\ChatMember;
use common\modules\bot\components\telegram\Entities\Entity;
use common\modules\bot\components\telegram\Entities\File;
use common\modules\bot\components\telegram\Entities\Message;
use common\modules\bot\components\telegram\Entities\User;
use common\modules\bot\components\telegram\Entities\UserProfilePhotos;
...
class ServerResponse extends Entity
{
    ...
    public function __construct(array $data, $bot_name)
    {
       ...
       // \Yii::info("ServerResponse  ".print_r(json_encode($data),true), 'chat');

        \Yii::info("ServerResponse  ", 'chat');

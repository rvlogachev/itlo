...
class Message extends Entity
{
    ...
    protected function init(array & $data, & $bot_name)
    {
        ...
        $this->invoicePayload = isset($data['invoicePayload']) ? $data['invoicePayload'] : null;
        if ($this->invoicePayload) {
            $this->type = 'invoicePayload';
        }

       


        $this->successful_payment = isset($data['successful_payment']) ? $data['successful_payment'] : null;
        if ($this->successful_payment) {
            $this->successful_payment = new SuccessfulPayment($this->successful_payment);

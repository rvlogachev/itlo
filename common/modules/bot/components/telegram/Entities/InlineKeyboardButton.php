...
class InlineKeyboardButton extends Entity
{
    ...
    public function __construct($data = array())
    {
        ...
        $this->switch_inline_query_current_chat = isset($data['switch_inline_query_current_chat']) ? $data['switch_inline_query_current_chat'] : null;

        if ($this->url === '' && $this->callback_data === '' && $this->switch_inline_query === '' && $this->switch_inline_query_current_chat) {

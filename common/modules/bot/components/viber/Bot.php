...
use common\modules\bot\components\viber\Bot\Manager;
use common\modules\bot\components\viber\Api\Event;
use common\modules\bot\components\viber\Api\Signature;
use common\modules\bot\components\viber\Api\Event\Factory;
use common\modules\bot\components\viber\Api\Entity;
...
class Bot
{
    ...
    public function onConversation(\Closure $handler)
    {
        ...
        \Yii::info("onConversation ", 'viberbot');
    ...
    public function onPicture(\Closure $handler)
    {
        $this->managers[] = new Manager(function (Event $event) {
            return (
                $event instanceof Message
                && $event->getMessage() instanceof Message\Picture
            );
        }, $handler);

...
namespace common\modules\bot\components\facebook;
...
class FbBotApp
{
     ...
     * @var string
     */
    protected $apiUrl = 'https://graph.facebook.com/v4.0/';
    ...
    public function call($url, $data, $type = self::TYPE_POST)
    {
        ...
        \Yii::info("  call send  FB" . print_r( $data, true), 'chat');
        ...
        curl_close($process);
           ...
           \Yii::info("  Return send  FB" . print_r( json_decode($return, true), true), 'chat');

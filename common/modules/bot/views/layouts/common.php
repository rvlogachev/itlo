...
$bundle1 = \common\modules\bot\assets\BotAsset::register($this);
        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Настройки виджета'),
                    ...
                    [
                        'label' => Yii::t('backend', 'Не распознанные вопросы'),
                        'icon' => '<i class="fa fa-users"></i>',
                        'url' => ['/messages/novalid'],
                        'active' => (Yii::$app->controller->id == 'user'),
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                        'label' => Yii::t('backend', 'База знаний бота'),
                        'icon' => '<i class="fa fa-users"></i>',
                        'url' => ['/question'],
                        'active' => (Yii::$app->controller->id == 'user'),
                        'visible' => Yii::$app->user->can('administrator'),
                    ...
                    [
                        'label' => Yii::t('backend', 'Общее системное'),
                        'url' => '#',
                        'icon' => '<i class="fa fa-th-large"></i>',
                        'options' => ['class' => 'treeview'],
                        'active' => (Yii::$app->controller->module->id == 'file'),

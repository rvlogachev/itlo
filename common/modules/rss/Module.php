 ...
 * @link            https://github.com/common\modules/yii2-rss
...
class Module extends BaseModule
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'common\modules\rss\controllers';
    ...
    public function dashboardNavItems($createLink = false)
    {
        $items = [
            'label' => $this->name,
            'icon' => FAS::icon('rss', ['class' => ['nav-icon']]),

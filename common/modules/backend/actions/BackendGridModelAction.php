...
use common\modules\backend\actions\assets\BackendGridModelActionAsset;
use common\modules\backend\BackendComponent;
use common\modules\backend\grid\ControllerActionsColumn;
use common\modules\backend\ViewBackendAction;
use common\modules\backend\widgets\GridViewWidget;
use common\modules\cms\modules\admin\widgets\gridViewStandart\GridViewStandartAsset;
use common\modules\cms\widgets\GridView;
use common\modules\cms\modules\config\storages\ConfigDbModelStorage;
...
class BackendGridModelAction extends ViewBackendAction
{
    ...
    /**
     * @var \common\modules\backend\widgets\FiltersWidget
     */
    public $filters;
    ...
    public function init()
    {
        ...
        $defaultGrid = [
            ...
            'beforeTableRight'   => function (GridViewWidget $gridViewWidget) {
                ...
                $editComponent = [
                    'url' => \common\modules\backend\helpers\BackendUrlHelper::createByParams([
                     //   BackendComponent::getCurrent()->backendShowingControllerRoute.
                        '/backend/admin-backend-showing/component-call-edit',
                    ])
                        ->merge([
                            'id'                 => $id,
...
JS
            ...
            'columns'            => [
                ...
                'checkbox' => [
                    'class'         => 'common\modules\cms\grid\CheckboxColumn',
                    'headerOptions' => [
        ...
        if ($this->isStandartAjaxPager) {
            $defaultGrid['pager'] = [
                'class'              => \common\modules\cms\modules\themeunifyv2\widgets\ScrollAndSpPager::class,
        ...
        $defaultFilters = [
            'class'              => \common\modules\backend\widgets\FiltersWidget::class,
            'filtersModel'       => [
                'formName' => 'f'.$this->id,
            ],
            'activeForm'         => [
...
CSS
    ...
    public function run()
    {
        ...
        return $this->render('@common/modules/backend/actions/views/grid', ['action' => $this]);
    }

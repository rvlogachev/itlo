...
namespace common\modules\backend\models;
 ...
 */
class BackendShowing extends \common\modules\cms\models\Core
{
    ...
    {
        return $this->hasOne(Users::className(), ['id' => 'cms_user_id']);
    }

...
/* @var $widget \common\modules\backend\widgets\FiltersWidget */
$widget = $this->context;
...
//                    print_r(\common\modules\backend\BackendComponent::getCurrent());
//                    die;

                    $editComponent = [
                        'url' => \common\modules\backend\helpers\BackendUrlHelper::createByParams([
                            //\common\modules\backend\BackendComponent::getCurrent()->backendShowingControllerRoute.

...
namespace common\modules\stats\models;
...
class Visitors extends ActiveRecord
{
    ...
    {
        if(class_exists('\common\modules\users\models\Users') && isset(Yii::$app->modules['users']) && !$user_id)
            return $this->hasOne(\common\modules\users\models\Users::class, ['id' => 'user_id']);
        else if(class_exists('\common\modules\users\models\Users') && isset(Yii::$app->modules['users']) && $user_id)

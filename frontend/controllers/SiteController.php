...
class SiteController extends Controller
{
    ...
    {
        if ($lang = Yii::$app->request->get('lang', false)) {
            ...
            if ($lang = Yii::$app->session->get('lang', false)) {
                Yii::$app->language = $lang;
    ...
    public function actionInchats()
    {

        $this->layout = "@frontend/templates/inchats/layouts/base";


        return $this->render('index');
    }

    public function actionCryptoparrot()
    {

        $this->layout = "@frontend/templates/cryptoparrot/layouts/main";


        return $this->render('cryptoparrot');
    }

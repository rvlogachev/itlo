...
<?= $this->render('_header', [
    ...
    <div class="profile-bio">
        <div class="row">
            <div class="col-md-5">
                <?php if ($model->image) : ?>
                    <img class="img-responsive md-margin-bottom-10" src="<?= \common\modules\cms\helpers\Image::getSrc($model->image->src); ?>" alt="">
                <?php else : ?>
                    <img class="img-responsive md-margin-bottom-10" src="<?= \common\modules\cms\helpers\Image::getSrc(); ?>" alt="">
                <?php endif; ?>

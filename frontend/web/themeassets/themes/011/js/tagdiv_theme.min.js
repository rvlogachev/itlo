    ...
    tdAnalytics = {
        _fbPixelId: "", _gaTrackingId: "", _gaErrors: [], _fbErrors: [], init: function () {
            !0 !== tdAnalytics._inIframe() && ("undefined" !== typeof window.dataLayer && window.dataLayer.forEach(function (a, b, c) {
                ...
                void 0 !== b.data("fb-event-name") &&
                (c.fb.eventName = b.data("fb-event-name"));
            ...
            0 === tdAnalytics._fbErrors.length && ("undefined" !== typeof a.fb.eventContentName ? fbq("track", a.fb.eventName, {content_name: a.fb.eventContentName}) : fbq("track", a.fb.eventName), console.log(" %c FB track sent", "color: green; font-weight: bold;"));
            setTimeout(function () {
...
(function (a) {
    a.fn.supersubs = function (b) {
        ...
        return this.each(function () {
            var b = a(this), e = a.meta ? a.extend({}, c, b.data()) : c, f = b.find("ul").show(),
...
(function (a) {
    var b = 0, c = 0, d = 0, e = 0, f = "ontouchstart" in window || 0 < navigator.msMaxTouchPoints,
        l = "onorientationchange" in window, g = !1, p = !1, x = !1, z = !1, C = !1, A = "pointer", G = "pointer",
        W = [], U = [], na = [], X = [], E = [], aa = [], H = [], r = [], D = [], ba = [], ia = [], m = {
            showScrollbar: function (b, c) {
                ...
                if (I.infiniteSlider) {
                    if (h <= -1 * D[q] || h <= -1 * ba[q]) {
                        ...
                        for (; h <= -1 * D[q];) {
                            var t = 0, O = m.getSliderOffset(a(c[0]), "x");
                            a(c).each(function (a) {
                    ...
                    if (h >= -1 * r[q] || 0 <= h) {
                        u = a(b).width();
                        if (0 < h)for (y = -1 * K[0], a(c).each(function (b) {
                            m.setSliderOffset(a(c)[b], y + A);
                            b < N.length && (N[b] = -1 * y);
                            y += B[b]
                        }), h -= -1 * N[0], r[q] = -1 * N[0] + A, D[q] = r[q] + u - k, H[q] = v; 0 <
                                       -1 * N[0] - u + A;) {
                            var F = 0, S = m.getSliderOffset(a(c[0]), "x");
                            a(c).each(function (a) {
                ...
                I.scrollbar && (e = Math.floor((-1 * h - r[q] + A) / (D[q] - r[q] + A) * (g - l - f)), b = f - p, h >= -1 * r[q] + A ? (b = f - p - -1 * e, m.setSliderOffset(a("." +
                    d), 0)) : (h <= -1 * D[q] + 1 && (b = g - l - p - e), m.setSliderOffset(a("." + d), e)), a("." + d).css({width: b + "px"}))
                ...
                a(b)[0] !== a(n)[0] && (k *= -1, e *= -2);
                n = H[B];
                if (Q.infiniteSlider)var t = r[B], O = D[B];
                I = [];
                y = [];
                ...
                n = (e + n + G) % G;
                t = 0;
                for (u = k; u < f.length; u += 2)if (u == k || 1 < Math.abs(f[u] - t) || u >= f.length - 2) t = f[u], h[h.length] = m.slowScrollHorizontalIntervalTimer(10 * u, b, c, f[u], d, g, l, p, x, z, e, A, C, q, G, v, B, L, n, Q);
                t = (e + H[B] + G) % G;
                ...
                c = "x" == c ? 4 : 5;
                if (!g || p || x)var h = parseInt(a(b).css("left"), 10); else {
                    h = ["-webkit-transform", "-moz-transform", "transform"];
                    for (var d, e = 0; e < h.length; e++)if (void 0 != a(b).css(h[e]) &&
                ...
                c = parseInt(c, 10);
                !g || p || x ? a(b).css({left: c + "px"}) : a(b).css({
            ...
            getSlideNumber: function (a, b, c) {
                ...
                var u = Math.ceil(n.autoSlideTransTimer / 10) + 1, k = m.getSliderOffset(c, "x"), y = A[b];
                y -= k;
                var t = b - (E[v] + H[v] + q) % q;
                if (n.infiniteSlider) {
                    b = (b - H[v] + 2 * q) % q;
                ...
                var k = Math.ceil(n.autoSlideTransTimer / 10) + 1, y = m.getSliderOffset(c, "x");
                u = (m.calcActiveOffset(n, b, z, g, H, q, E[v], v) + H[v] + q) % q;
                var t = z.slice();
                if (n.snapToChildren && !n.infiniteSlider) b = z[u]; else if (n.infiniteSlider && n.snapToChildren) {
                ...
                for (var h = [], f = 0; f < 2 * e.hardwareAccelBuffer; f++) {
                    ...
                    if ("visible" == a(b).eq(g).css("-webkit-backface-visibility")) {
                        h[h.length] =
                            g;
                        var u = m.mod(g + 2 * e.hardwareAccelBuffer, d), l = m.mod(g - 2 * e.hardwareAccelBuffer, d);
            ...
            return a(O).each(function (g) {
                function u() {
                    ...
                    if (h.infiniteSlider && !fa) {
                        ...
                        for (c = (H[k] + P) % P * -1; 0 > c;) {
                            var d = 0, e = m.getSliderOffset(a(J[0]), "x");
                            a(J).each(function (a) {
                        ...
                        for (; 0 < -1 * w[0] - ea + n && h.snapSlideCenter && va;) {
                            var g = 0, u = m.getSliderOffset(a(J[0]), "x");
                            a(J).each(function (a) {
                    ...
                    h.scrollbar && (a("." + S).css({
                        ...
                        overflow: "hidden",
                        display: "none"
                    }), a("." + S + " ." + K).css({border: h.scrollbarBorder}), T = parseInt(a("." + S).css("marginLeft")) + parseInt(a("." + S).css("marginRight")), V = parseInt(a("." + S + " ." + K).css("borderLeftWidth"), 10) + parseInt(a("." + S + " ." + K).css("borderRightWidth"), 10), v = "" != h.scrollbarContainer ? a(h.scrollbarContainer).width() : L, B = L / ea * (v - T), h.scrollbarHide || (wa = h.scrollbarOpacity), a("." + S).css({
                        position: "absolute",
                        left: 0,
                        width: v - T + "px",
                        margin: h.scrollbarMargin
                        ...
                        a("." + S).css({display: "block"}), N = a("." + S + " ." + K), W = a("." + S));
                    ...
                    "" != h.navPrevSelector && (a(h.navPrevSelector).css({cursor: "pointer"}),
                ...
                r[k] = 0;
                D[k] = 0;
                var O = [0, 0], C = [0, 0], S = "scrollbarBlock" + b, K = "scrollbar" + b, N, W, v, B, q, ua, n = 0,
                    I = a(this), L, Q, T, V, Ba, va = !0;
                g = -1;
                var w, Y = [], wa = 0, ja = 0, Fa = 0, M = a(this).children(":first-child"),
                    J, ma, R, P = a(M).children().not("script").length, ha = !1, Da = 0, ya = !1, ra = void 0, Z;
                H[k] = 0;
                var fa = !1, oa = !1;
                na[k] = !1;
                var ka, sa = !1, pa = !1, da = "touchstart.iosSliderEvent click.iosSliderEvent", ea, xa, Ca, qa;
                ia[k] = !1;
                X[k] = [];
                ...
                !h.keyboardControls && !h.tabToAdvance || fa || a(document).bind("keydown.iosSliderEvent", function (a) {
                    ...
                    if (37 == a.keyCode && h.keyboardControls) a.preventDefault(), a = (E[k] + H[k] + P) % P, (0 < a || h.infiniteSlider) && m.changeSlide(a - 1, M, J, t, K, B, L, v, T, V, Y, w, R, k, Z, P, n, h); else if (39 == a.keyCode && h.keyboardControls || 9 == a.keyCode && h.tabToAdvance) a.preventDefault(),
                ...
                if (f || h.desktopClickDrag) {
                    ...
                    a(g).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent", function (b) {
                        ...
                        b > -1 * r[k] + n + ea ? (b = -1 * r[k] + n + ea, m.setSliderOffset(a("." + K), b), a("." + K).css({width: B - V + "px"})) : b < -1 * D[k] && (b = -1 * D[k], m.setSliderOffset(a("." + K), v - T - B), a("." + K).css({width: B - V + "px"}));
                    ...
                    a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent",
                        function (b) {
                            ...
                            if (ha && !sa) {
                                ...
                                if (h.infiniteSlider) {
                                    if (g <= -1 * D[k]) {
                                        ...
                                        if (g <= -1 * ba[k]) {
                                            ...
                                            var G = 0, S = m.getSliderOffset(a(J[0]), "x");
                                            a(J).each(function (a) {
                                    ...
                                    if (g >= -1 * r[k] || 0 <= g)if (F = a(M).width(), 0 <= g)for (q = -1 * Y[0], a(J).each(function (b) {
                                        m.setSliderOffset(a(J)[b],
                                            q + n);
                                        b < w.length && (w[b] = -1 * q);
                                        q += R[b]
                                    }), ja += -1 * w[0], r[k] = -1 * w[0] + n, D[k] = r[k] + F - L, H[k] = P; 0 < -1 * w[0] - F + n;) {
                                        var W = 0, Q = m.getSliderOffset(a(J[0]), "x");
                                        a(J).each(function (a) {
                                ...
                                h.scrollbar && (m.showScrollbar(h, K), e = Math.floor((ja - eventX - f - r[k] + t) / (D[k] - r[k] + n) * (v - T - B) * l), g = B, 0 >= e ? (g = B - V - -1 * e, m.setSliderOffset(a("." + K), 0), a("." + K).css({width: g + "px"})) : e >= v - T - V - B ? (g = v - T - V - e, m.setSliderOffset(a("." +
                                    K), e), a("." + K).css({width: g + "px"})) : m.setSliderOffset(a("." + K), e));
                    ...
                    a(g).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",
                        function (a) {
                            ...
                            if (0 != a.touches.length)for (var b = 0; b < a.touches.length; b++)a.touches[b].pageX == Ba && m.slowScrollHorizontal(M, J, t, K, c, d, B, L, v, T, V, Y, w, R, k, Z, P, ka, pa, n, h); else m.slowScrollHorizontal(M, J, t, K, c, d, B, L, v, T, V, Y, w, R, k, Z, P, ka, pa, n, h);
                            la = sa = !1;
                            return !0
                        });
    ...
    a.fn.iosSlider = function (b) {
        ...
        if ("object" !== typeof b && b) a.error("invalid method call!"); else return ca.init.apply(this, arguments)
    }
})(jQuery);
(function (a) {
    var b, c, d, e, f, l, g, p = function () {
    }, x = !!window.jQuery, z = a(window), C = function (a, c) {
        b.ev.on("mfp" + a + ".mfp", c)
    }, A = function (b, c, d, e) {
    ...
    p.prototype = {
        constructor: p, init: function () {
            ...
            }) : b.wrap.css({top: z.scrollTop(), position: "absolute"});
            ...
            if (b.bgOverlay.detach(), b.wrap.detach(),
                    b.container.empty(), b.st.mainClass && (c += b.st.mainClass + " "), b._removeClassFromMFP(c), b.fixedContentPos) c = {marginRight: ""}, b.isIE7 ? a("body, html").css("overflow", "") : c.overflow = "", a("html").css(c);
            ...
            if (e.tagName ? e = {el: a(e)} : (d = e.type, e = {data: e, src: e.src}), e.el) {
                for (var f = b.types, h = 0; f.length > h; h++)if (e.el.hasClass("mfp-" + f[h])) {
                    d = f[h];
                    break
                }
    ...
    a.magnificPopup = {
        instance: null, proto: p.prototype, modules: [], open: function (b, c) {
    ...
    a.fn.magnificPopup = function (c) {
        ...
        } else b.isOpen && b[c].apply(b, Array.prototype.slice.call(arguments, 1)); else c = a.extend(!0, {}, c), x ? d.data("magnificPopup", c) : d[0].magnificPopup = c, b.addGroup(d, c);
        return d
    };
...
(function (a, b, c) {
    ...
    var g = "placeholder" in b.createElement("input"), p = "placeholder" in b.createElement("textarea"), x = c.fn,
        z = c.valHooks, C = c.propHooks;
...
(function () {
    tdMenu = {
        ...
        init: function () {
            var a = jQuery("#td-header-menu .sf-menu"), b = jQuery("#td-header-menu .sf-menu, .top-header-menu"),
    ...
    tdUtil = {
        ...
        scrollToPosition: function (a, b) {
            if (window.location !== window.parent.location) {
                var c = jQuery(window.parent.document), d = c.find("#" + jQuery("html").attr("id")).offset().top;
                tdIsScrollingAnimation = !0;
                c.find("html, body").stop();
                c.find("html, body").animate({scrollTop: d + a}, {
                    duration: b, easing: "easeInOutQuart",
                    complete: function () {
                        tdIsScrollingAnimation = !1
                    }
                })
            } else tdIsScrollingAnimation = !0, jQuery("html, body").stop(), jQuery("html, body").animate({scrollTop: a}, {
                duration: b,
                easing: "easeInOutQuart",
                complete: function () {
                    tdIsScrollingAnimation = !1
...
function td_resize_videos() {
    ...
    jQuery(document).find('iframe[src*="dailymotion.com"]').each(function () {
        var a = jQuery(this).parent().parent().parent(), b = a.hasClass("vc_video-aspect-ratio-43");
        a = a.hasClass("vc_video-aspect-ratio-235");
...
function td_post_template_6_title() {
    ...
    var b = document.getElementById("td_parallax_header_6"), c = document.getElementById("td-full-screen-header-image"),
        d = "", e;
        ...
        "undefined" === typeof window.parent.tdcAdminSettings && (a = jQuery(this), a.hasClass("td-mfp-loaded") || (a.addClass("td-mfp-loaded"),
            a.magnificPopup({
                ...
                iframe: {
                    patterns: {
                        youtube: {
                            index: "youtube.com/", id: function (a) {
...
function td_scroll_to_class() {
    jQuery("[data-scroll-to-class]").on("click", function (a) {
        ...
        var b = jQuery(this), c = b.offset(), d = b.data("scroll-to-class");
...
jQuery(window).on('load', function () {
    var a = td_read_site_cookie("td-cookie-scroll-to-class"), b = td_read_site_cookie("td-cookie-scroll-offset");
    ...
    tdAjaxSearch = {
        ...
        init: function () {
            ...
            jQuery("#td-header-search").keydown(function (a) {
                if (a.which && 39 === a.which || a.keyCode && 39 === a.keyCode || a.which &&
                    37 === a.which || a.keyCode && 37 === a.keyCode) tdAjaxSearch.td_aj_search_input_focus(); else {
                    ...
                    (a.which && 8 === a.which || a.keyCode &&
                    8 === a.keyCode) && 1 === jQuery(this).val().length && jQuery("#td-aj-search").empty();
            ...
            jQuery("#td-header-search-mob").keydown(function (a) {
                if (a.which && 13 === a.which || a.keyCode && 13 === a.keyCode)return a = jQuery(".td-aj-cur-element"), 0 < a.length ? (a = a.find(".entry-title a").attr("href"), window.location = a) : jQuery(this).parent().parent().submit(), !1;
                (a.which && 8 === a.which || a.keyCode && 8 === a.keyCode) && 1 === jQuery(this).val().length &&
        ...
        move_prompt_down: function () {
            !0 === tdAjaxSearch._first_down_up ? tdAjaxSearch._first_down_up = !1 : tdAjaxSearch._current_selection_index ===
            tdAjaxSearch._last_request_results_count ? tdAjaxSearch._current_selection_index = 0 : tdAjaxSearch._current_selection_index++;
            tdAjaxSearch._repaintCurrentElement()
        },
...
jQuery().ready(function () {
    ...
    "undefined" !== typeof window.tds_general_modal_image && "" !== window.tds_general_modal_image && jQuery(".single .td-post-content a > img").filter(function (a, b) {
        if (-1 !== b.className.indexOf("wp-image")) {
            var c = jQuery(b), d = c.parent(), e = d.attr("href");
            -1 === e.indexOf(document.domain) || -1 === e.indexOf("uploads") && -1 ===
            e.indexOf("attachment") || (d.addClass("td-modal-image"), -1 !== e.indexOf("attachment") && d.attr("href", c.attr("src")))
        }
    })
});
...
(function () {
    ...
    tdBlocks = {
        tdPullDownFilterChangeValue: function (a, c) {
            ...
            console.log(e);
            jQuery.ajax({
                type: "POST", url: td_ajax_url, cache: !0, data: e, success: function (a, d, e) {
...
jQuery().ready(function () {
    ...
    jQuery(".td-login-modal-js, .comment-reply-login").on("click", function (a) {
        ...
        }, 500), tdLogin.showHideElementsMobile([["#td-login-mob",
            1], ["#td-register-mob", 0], ["#td-forgot-pass-mob", 0]]))
    });
...
(function () {
    tdLogin = {
        ...
        handlerRegister: function () {
            var a =
                jQuery("#register_email"), b = jQuery("#register_user");
        ...
        showHideElementsMobile: function (a) {
            if (a.constructor === Array)for (var b =
                a.length, c = 0; c < b; c++)if (a[c].constructor === Array && 2 === a[c].length) {
                var d = jQuery(a[c][0]);
...
(function () {
    tdLoginMob = {
        ...
        handlerRegister: function () {
            var a =
                jQuery("#register_email-mob"), b = jQuery("#register_user-mob");
    ...
    tdDemoMenu = {
        mousePosX: 0, mousePosY: 0, init: function () {
            ...
            a(".td-set-theme-style-link").hover(function (b) {
                var c = a(this), e =
                    c.closest(".td-set-theme-style"), f = a(".td-screen-demo:first"), l = 0, g = 0;
                var p = a("#wpadminbar");
            ...
            var c = a(".td-screen-demo:first"), e = a("#wpadminbar"),
            ...
            a(".td-set-theme-style-link").each(function (b, e) {
                ...
                parseInt(d.outerHeight()) && (l = !0, parseInt(a(window).width()) - 2 * parseInt(d.outerWidth()) < tdDemoMenu.mousePosX && tdDemoMenu.mousePosX < parseInt(a(window).width()) - parseInt(d.outerWidth()) && (g = !0)); else {
...
(function () {
    tdSmartSidebar = {
        ...
        td_events_scroll: function (a) {
            if (!1 !==
                tdSmartSidebar.hasItems)if (!1 === tdSmartSidebar.is_enabled) {
        ...
        td_events_resize: function () {
            ...
            switch (tdSmartSidebar._view_port_current_interval_index) {
                case 0:
                    ...
                    tdSmartSidebar.is_enabled_state_run_once =
                        !1;
                    break;
                case 1:
...
var Froogaloop = function () {
    ...
    a.fn = a.prototype = {
        element: null, init: function (a) {
            ...
            if (!this.element ||
                !a)return !1;
            var e = this.element, f = "" !== e.id ? e.id : null, g = c && c.constructor && c.call && c.apply ? null : c,
    ...
    tdCustomEvents = {
        _callback_scroll: function () {
            ...
            jQuery("body").find(".tdc-video-inner-wrapper").each(function () {
                var a = jQuery(this), c = a.find("iframe");
                if (c.length) {
...
(function () {
    tdHeader = {
            ...
            if (tdHeader._isInitialized) {
                ...
                tdEvents.scroll_window_scrollTop ? tdHeader._headerDesktopHeight < tdEvents.scroll_window_scrollTop && (tdHeader.$_headerDesktop.addClass("td-header-active"), tdHeader.$_headerDesktopSticky.removeClass("td-header-active")) : tdHeader._previousScrollPosition > tdEvents.scroll_window_scrollTop && (tdHeader._headerDesktopHeight + parseInt(tdHeader._headerDesktopStickyGap) < tdEvents.scroll_window_scrollTop ? (tdHeader.$_headerDesktop.removeClass("td-header-active"), tdHeader.$_headerDesktopSticky.addClass("td-header-active")) :
                    ...
                    (tdHeader.$_headerDesktop.hasClass("td-header-active") && tdHeader.$_headerDesktopSticky.addClass("td-header-stop-transition"), tdHeader.$_headerDesktop.addClass("td-header-active"), tdHeader.$_headerDesktopSticky.removeClass("td-header-active")) : tdHeader._previousScrollPosition > tdEvents.scroll_window_scrollTop && (tdHeader._headerDesktopHeight + parseInt(tdHeader._headerDesktopStickyGap) < tdEvents.scroll_window_scrollTop ? (tdHeader.$_headerDesktop.removeClass("td-header-active"), tdHeader.$_headerDesktopSticky.addClass("td-header-active")) :
                        (tdHeader._headerDesktopHeight > tdEvents.scroll_window_scrollTop && tdHeader.$_headerDesktop.hasClass("td-header-active") && tdHeader.$_headerDesktopSticky.addClass("td-header-stop-transition"), tdHeader.$_headerDesktop.addClass("td-header-active"), tdHeader.$_headerDesktopSticky.removeClass("td-header-active"))));
                if (window.parent === window.top && "undefined" !== typeof window.parent.tdcSidebar) {
                    var a = tdHeader.getActiveHeaderSelector();
                    if ("undefined" === typeof tdHeader.previousActiveHeaderSelector || a !== tdHeader.previousActiveHeaderSelector) tdHeader.previousActiveHeaderSelector =
                        a, window.parent.tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active"), "undefined" !== typeof tdHeader.timeoutHeaderTemplate && clearTimeout(tdHeader.timeoutHeaderTemplate), tdHeader.timeoutHeaderTemplate = setTimeout(function () {
                        ...
                        tdHeader._isMobile ? tdHeader.$_headerMobileSticky.hasClass("tdc-zone-sticky-active") ? tdHeader.$_headerMobileSticky.removeClass("tdc-zone-sticky-invisible") :
        ...
        getActiveHeaderSelector: function () {
            if (tdHeader._isInitialized)return tdHeader._isMobile ? tdHeader.$_headerMobileSticky.hasClass("td-header-active") ? tdHeader._selectorDataHeaderMobileSticky : tdHeader._selectorDataHeaderMobile :
                tdHeader.$_headerDesktopSticky.hasClass("td-header-active") ? tdHeader._selectorDataHeaderDesktopSticky : tdHeader._selectorDataHeaderDesktop
        }
    };
    jQuery(window).on('load', function () {
        tdHeader.init();
        ...
        tdPlayerContainer: "player_youtube", players: [], init: function () {
            ...
            var c = {
                ...
                onPlayerStateChange: function (a) {
                    if (a.data ===
                        YT.PlayerState.PLAYING) c.pauseStatus(); else if (a.data === YT.PlayerState.ENDED) {
                        c.playStatus();
                        c.autoplay = 1;
                        a = "";
            ...
            var c = {
                ...
                createPlayer: function (a) {
                    if ("" !== a) {
                        ...
                        var b = "", d = window.td_vimeo_list_ids["td_" + a].title,
    ...
    tdPullDown = {
        _view_port_interval_index: tdViewport.INTERVAL_INITIAL_INDEX, items: [], item: function () {
            ...
            if (!1 !== a._is_initialized) {
                ...
                var b = 0, c = a.container_jquery_obj.width();
                if (void 0 !== c && "" !== c) {
                    b = c;
                ...
                for (; (0 < a._horizontal_elements.length || 0 === a._horizontal_elements.length && 0 === a.minimum_elements) && 0 < a._vertical_elements.length && b >= a._vertical_elements[0].calculated_width;)if (d =
                        tdPullDown._make_element_horizontal(a), null !== d) b -= d.calculated_width; else {
                    tdPullDown._prepare_horizontal_header(a);
                    return
                }
            ...
            for (c in a.properties)if (!0 === a.properties.hasOwnProperty(c)) {
                ...
                for (e = 0; e < d.settings.length; e++) {
                    ...
                    if (f.start_percent <= a.percent_value && a.percent_value < f.end_percent || a.percent_value === f.end_percent && 100 === a.percent_value) {
                        if (f.start_value === f.end_value) f = f.start_value; else if (e = (a.percent_value - f.start_percent) / (f.end_percent - f.start_percent) * (f.end_value - f.start_value), void 0 === f.easing || "" === f.easing) f = f.start_value + e; else {
    ...
    tdAnimationStack = {
        ...
        ready_init: function () {
            tdDetect.isIe8 || tdDetect.isIe9 || 0 < jQuery(".vc_images_carousel").length ? (tdAnimationStack._ready_for_initialization = !1, void 0 !== window.td_animation_stack_effect && ("" === window.td_animation_stack_effect && (window.td_animation_stack_effect =
                ...
                if (!0 !== tdAnimationStack.activated) {
                    ...
                    a.each(function (a, c) {
                        var b = jQuery(c).data("type"), e = jQuery(c);
        ...
        check_for_new_items: function (a, b, c, d) {
            if (!1 !== tdAnimationStack.activated && !1 !== tdAnimationStack._ready_for_initialization) {
                ...
                !0 === d ? (tdAnimationStack.log("%c live load items ", "background: brown; color: white;"), tdAnimationStack._precompute_items(e, b, c), tdAnimationStack.compute_items(d)) : (tdAnimationStack.log("%c preload items ", "background: brown; color: white;"), function () {
                    for (var a = !0, d = 0; d < e.length; d++)if (!1 === f[d].complete) {
                        a = !1;
                        break
                    }
                    if (!1 === a) {
                        ...
                        var x =
                            setInterval(function () {
                                var d;
                                if ((new Date).getTime() - p > tdAnimationStack.max_waiting_for_init)for (clearInterval(x), d = 0; d < e.length; d++)e[d].jqueryObj.removeClass(tdAnimationStack._animation_css_class1), e[d].jqueryObj.addClass(tdAnimationStack._animation_css_class2); else {
                                    a = !0;
        ...
        _load_item: function (a, b) {
            if (void 0 === a.itemSrc) tdAnimationStack.log("%c item with no data url ",
                "background: #fc6600; color: #fff;"), a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1), a.jqueryObj.addClass(tdAnimationStack._animation_css_class2); else {
                var c = a.itemType;
                if (void 0 !== c)switch (c) {
                    case "image_tag":
                        tdAnimationStack.log("%c image tag ", "background: #3ded97; color: #fff;");
                        a.jqueryObj.data("complete", !1);
                        void 0 !== a.itemImgRetinaSrc && !0 === tdAnimationStack._isHighDensity() ? a.jqueryObj.attr("src", a.itemImgRetinaSrc).on('load', function () {
                            a.jqueryObj.data("complete", !0)
                        }) : a.jqueryObj.attr("src",
                            a.itemSrc).on('load', function () {
                            a.jqueryObj.data("complete", !0)
                        });
                        var d = (new Date).getTime(), e = setInterval(function () {
                                var b = new Date;
                    ...
                    case "css_image":
                        a.jqueryObj.data("complete", !1);
                        tdAnimationStack.log("%c image tag ", "background: #3ded97; color: #fff;");
                        void 0 !== a.itemImgRetinaSrc && !0 === tdAnimationStack._isHighDensity() ? jQuery("<img/>").attr("src", a.itemImgRetinaSrc).on('load', function () {
                            jQuery(this).remove();
                            a.jqueryObj.data("complete", !0)
                        }) : jQuery("<img/>").attr("src", a.itemSrc).on('load', function () {
                            jQuery(this).remove();
                            a.jqueryObj.data("complete", !0)
                        });
                        var f = (new Date).getTime(), l = setInterval(function () {
                            var b = new Date;
                            !0 ===
...
"enabled" == tdUtil.getBackendVar("tds_smart_sidebar") && jQuery(window).on('load', function () {
    jQuery(".td-ss-row").each(function () {
        var a = new tdSmartSidebar.item, c = jQuery(this).children(".td-pb-span8").find(".wpb_wrapper:first"),
    ...
    jQuery(".vc_row").each(function () {
        ...
        jQuery(this).children(".vc_column").each(function (b, e) {
            var d = jQuery(e);
            if (d.hasClass("td-is-sticky")) a.push(d.find(".wpb_wrapper:first")); else if ("undefined" === typeof c || c.outerHeight(!0) < d.outerHeight(!0)) c = d.find(".wpb_wrapper:first")
        });
    ...
    if (0 < jQuery(".td-ss-main-content").length && 0 < jQuery(".td-ss-main-sidebar").length) {
        ...
        a.content_jquery_obj =
            jQuery(".td-ss-main-content");
...
function td_compute_parallax_background(a) {
    a = jQuery(a);
    var b = Math.round(.2 * a.height()), c = -1 * b, d = new tdAnimationScroll.item;
    d.jqueryObj = a;
...
function td_compute_backstretch_item(a) {
    var b = 100 * (tdEvents.window_innerHeight - a.offset_top) / (tdEvents.window_innerHeight + a.full_height),
        c = 100 * tdEvents.window_innerHeight / (tdEvents.window_innerHeight + a.full_height), d = a.offset_top / 4;
    0 == d && (d = 100);
    ...
    tdWeather = {
        ...
        _renderCurrentItem: function () {
            var a = jQuery("#" + tdWeather._currentItem.block_uid),
                b = tdWeather._currentLatitude, c = tdWeather._currentLongitude, d = tdWeather._currentLocation;
        ...
        _owmGetFiveDaysData2: function (a) {
            ...
            for (var b = {}, c = !0, d = Object.prototype.hasOwnProperty, e = 0; e < a.list.length; e++)if (d.call(a.list[e], "dt")) {
                c = a.list[e].dt;
...
jQuery(window).ready(function () {
    jQuery(".td_smart_list_1 a, .td_smart_list_3 a").click(function (a) {
        if (a.target === a.currentTarget) {
            var b = jQuery(this).attr("target"), c = jQuery(this)[0].hasAttribute("download"),
...
(function () {
    tdAnimationSprite = {
        items: [], isInRequestAnimation: !1, item: function () {
            ...
            for (var b =
                0; b < tdAnimationSprite.items.length; b++)if (tdAnimationSprite.items[b].blockUid === a)return tdAnimationSprite.items.splice(b, 1), !0;
            return !1
...
function td_date_i18n(a, b) {
    ...
    var l = {
        d: function () {
            ...
            var a =
                new Date(l.Y(), l.n() - 1, l.j()), b = new Date(l.Y(), 0, 1);
            return Math.round((a - b) / 864E5)
        }, W: function () {
            var a = new Date(l.Y(), l.n() - 1, l.j() - l.N() + 3), b = new Date(a.getFullYear(), 0, 4);
            ...
            var a = new Date(l.Y(), 0), b = Date.UTC(l.Y(), 0), c = new Date(l.Y(), 6), d = Date.UTC(l.Y(), 6);
            return a - b !== c - d ? 1 : 0
        }, O: function () {
        ...
        init: function () {
            jQuery(".td-social-sharing-button").click(function (a) {
                ...
                if (!b.hasClass("td-social-mail") && !b.hasClass("td-social-share-text"))if (a.preventDefault(), b.hasClass("td-social-expand-tabs")) {
                    a = b.data("block-uid");
                    var c = jQuery("#" + a), d = b.find(".td-social-expand-tabs-icon");
            ...
            setTimeout(function () {
                jQuery(".td-post-sharing").each(function (a, b) {
                    var c = jQuery(b), d = c.find(".td-post-sharing-visible:first"), e = new tdPullDown.item;

...
<?php echo FAS::icon('search', ['class' => 'bg-green']) ?>
<div class="timeline-item">
	...
	<p style="margin: 10px;"> <?= isset($model->data['desc'])?$model->data['desc']:'';?> :  <?= isset($model->data['data']['result'])?$model->data['data']['result']:'';?></p>

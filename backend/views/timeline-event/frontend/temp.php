...
<?php echo FAS::icon('temperature-low', ['class' => 'bg-green']) ?>
<div class="timeline-item">
    ...
    <p style="margin: 10px;"> <?= isset($model->data['desc'])?$model->data['desc']:'';?> :  <?= isset($model->data['data']['temp'])?$model->data['data']['temp']." °C":'';?></p>
